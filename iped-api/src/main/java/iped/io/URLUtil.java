...
/** Helpers to obtain the code-source URL of a class, working around Windows UNC path issues. */
public class URLUtil {
  /**
   * Return a URL from a Class. This method was created to handle Windows unmapped network paths,
   * like \\server\case. It adds another "//" before the actual path name to avoid an
   * IllegalArgumentException: URI has an authority component. See issue #1336.
   *
