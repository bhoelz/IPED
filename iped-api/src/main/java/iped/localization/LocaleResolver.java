...
/**
 * Resolves the application locale from the {@value #LOCALE_SYS_PROP} system
 * property, falling back to the JVM default locale.
 */
public class LocaleResolver {
    ...
    /**
     * @return the configured application locale, or the JVM default if none was
     *         set
     */
