...
/**
 * Two-way mapping between internal (non-localized) property names and their
 * localized display names, loaded lazily from the {@code iped-properties}
...
public class LocalizedProperties {
    ...
    private static synchronized void loadLocalizedProps() {
        ...
        ResourceBundle RESOURCE_BUNDLE = Messages.getExternalBundle(BUNDLE_NAME, LocaleResolver.getLocale());
