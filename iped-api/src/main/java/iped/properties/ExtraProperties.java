...
public class ExtraProperties {
   ...
   */
  @Deprecated public static final String TIKA_PARSER_USED = TIKA_PARSER_USED_KEY;
  ...
  public static final Property DOWNLOAD_DATE =
      Property.internalDate(DOWNLOAD_DATE_KEY); // $NON-NLS-1$
  ...
  public static final Property CONVERSATION_IS_OWNER_ADMIN =
      Property.internalBoolean(CONVERSATION_IS_OWNER_ADMIN_KEY);
  ...
  public static final String CONVERSATION_MESSAGES_COUNT_KEY =
      CONVERSATION_PREFIX + "messagesCount";

  /** Number of messages in the conversation, as an integer property. */
  public static final Property CONVERSATION_MESSAGES_COUNT =
      Property.internalInteger(CONVERSATION_MESSAGES_COUNT_KEY);
  ...
  public static final Property COMMUNICATION_DATE =
      Property.internalDate(COMMUNICATION_DATE_KEY); // $NON-NLS-1$
  ...
  public static final String MESSAGE_IS_ATTACHMENT =
      MESSAGE_PREFIX + "IsEmailAttachment"; // $NON-NLS-1$

  /** Number of attachments of a message, as a string key. */
  public static final String MESSAGE_ATTACHMENT_COUNT_KEY =
      MESSAGE_PREFIX + "AttachmentCount"; // $NON-NLS-1$

  /** Number of attachments of a message, as an integer property. */
  public static final Property MESSAGE_ATTACHMENT_COUNT =
      Property.internalInteger(MESSAGE_ATTACHMENT_COUNT_KEY); // $NON-NLS-1$
  ...
  public static final Property CARVEDOFFSET_METADATA_NAME =
      Property.internalInteger(CARVEDOFFSET_METADATA_NAME_KEY); // $NON-NLS-1$
  ...
  public static final List<String> COMMUNICATION_BASIC_PROPS =
      Arrays.asList(
          MESSAGE_SUBJECT,
          MESSAGE_BODY,
          MESSAGE_PREFIX + "CC",
          MESSAGE_PREFIX + "BCC",
          MESSAGE_PREFIX + "Recipient-Address",
