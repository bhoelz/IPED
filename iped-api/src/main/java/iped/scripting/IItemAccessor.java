...
/**
 * Scripting-SDK accessor for reading item content and metadata without
 * coupling scripts to engine-internal item implementations.
 *
...
public interface IItemAccessor {
    ...
    /**
     * Returns the path of the item within the case (e.g.
     * {@code /disk.E01/unallocated/file.doc}).
     *
     ...
     *
     * @return MIME type string such as {@code "application/pdf"}; may be
     *         {@code null} if type detection was not performed
     */
    String getMediaType();
    ...
    /**
     * Returns the SHA-256 hash of the item content in hex, or {@code null} if
     * not computed.
     *
    ...
    /**
     * Returns {@code true} if this item has been marked as deleted in the source
     * (e.g. a deleted file in a disk image).
     *
    ...
    /**
     * Returns {@code true} if this item is a directory/container (e.g. a folder
     * or a compound file entry that has children).
     *
