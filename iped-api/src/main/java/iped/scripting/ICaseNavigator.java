 ...
 *
 * <p>Implementations are provided by the engine and injected into JS/Python
 * script contexts at runtime. Scripts should never attempt to instantiate this
 * interface directly.
 *
 * @since 4.2
 */
public interface ICaseNavigator {
    ...
    /**
     * Returns an {@link IItemAccessor} for reading content and metadata of the
     * given item without directly importing engine types.
     *
