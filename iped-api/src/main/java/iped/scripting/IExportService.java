...
public interface IExportService {
    ...
    /**
     * Exports the raw content of the given item to {@code destination}.
    ...
    /**
     * Exports the content of each item in {@code itemIds} under
     * {@code destinationDir}, preserving the relative case path as a
    ...
    /**
     * Exports the metadata of all items in {@code itemIds} as a CSV file written
     * to {@code destination}.
     *
    ...
    /**
     * Exports the items in {@code bookmarkName} as a self-contained HTML report
     * written under {@code destinationDir}.
     *
