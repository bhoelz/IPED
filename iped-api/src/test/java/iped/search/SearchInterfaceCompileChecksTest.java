...
/**
 * Compile-check tests for search interfaces. Each test verifies that the interface is implementable
 * and exercises any accessible constants.
 */
