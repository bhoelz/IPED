...
/**
 * Ensures iped-api contains no compile-time dependency on any other IPED module. iped-api is the
 * public contract layer; only SLF4J and standard libraries are permitted as runtime dependencies.
 */
    ...
    ArchRule rule =
        noClasses()
            ...
            .resideInAnyPackage(
                ...
                "iped.utils..")
            .because(
                "iped-api must remain a zero-implementation contract layer with no "
