 ...
 * The default methods use reflection to delegate to concrete implementations.
 */
class IItemDefaultMethodsTest {
    ...
    @Test
    @DisplayName("setMediaType(Object) when no matching method found should throw UnsupportedOperationException")
    ...
    void setMetadataValue_whenMetadataNull_shouldThrow() {
        ...
        assertThrows(UnsupportedOperationException.class,
                () -> item.setMetadataValue("key", "value"));
    }
    ...
    void addMetadataValue_whenMetadataNull_shouldThrow() {
        ...
        assertThrows(UnsupportedOperationException.class,
                () -> item.addMetadataValue("key", "value"));
    }
    ...
    /**
     * Fake metadata object with set/add/get/getValues/remove/names methods
     * that match the reflective calls from IItem/IItemReader default methods.
     */
    ...
    static class StubItem implements IItem {
        ...
        @Override public Object getMediaType() { return mediaTypeValue; }
        @Override public void addCategory(String category) {}
        @Override public void addParentId(int parentId) {}
        @Override public void addParentIds(List<Integer> parentIds) {}
        ...
        @Override public Object getTempAttribute(String key) { return null; }
        ...
        @Override public void removeCategory(String category) {}
        @Override public void setAccessDate(Date accessDate) {}
        @Override public void setAddToCase(boolean addToCase) {}
        @Override public void setCarved(boolean carved) {}
        @Override public void setCategory(String category) {}
        @Override public void setCreationDate(Date creationDate) {}
        @Override public void setDataSource(IDataSource evidence) {}
        @Override public void setDeleted(boolean deleted) {}
        @Override public void setExtension(String ext) {}
        @Override public void setExtraAttribute(String key, Object value) {}
        @Override public void setTempAttribute(String key, Object value) {}
        @Override public void setFileOffset(long fileOffset) {}
        @Override public void setHasChildren(boolean hasChildren) {}
        @Override public void setHash(String hash) {}
        @Override public void setId(int id) {}
        @Override public void setIsDir(boolean isDir) {}
        @Override public void setLabels(List<String> labels) {}
        @Override public void setLength(Long length) {}
        @Override public void setModificationDate(Date modificationDate) {}
        @Override public void setName(String name) {}
        @Override public void setParent(IItem parent) {}
        @Override public void setParentId(Integer parentId) {}
        @Override public void setParsed(boolean parsed) {}
        @Override public void setParsedTextCache(String parsedTextCache) {}
        @Override public void setPath(String path) {}
        @Override public void setQueueEnd(boolean isQueueEnd) {}
        @Override public void setChangeDate(Date changeDate) {}
        @Override public void setRoot(boolean isRoot) {}
        @Override public void setSubItem(boolean isSubItem) {}
        @Override public void setSumVolume(boolean sumVolume) {}
        @Override public void setTimeOut(boolean timeOut) {}
        @Override public void setToExtract(boolean isToExtract) {}
        @Override public void setToIgnore(boolean toIgnore) {}
        @Override public void setToIgnore(boolean toIgnore, boolean updateStats) {}
        @Override public void setType(String type) {}
        @Override public void setViewFile(File viewFile) {}
        @Override public void setHasPreview(boolean b) {}
        @Override public void setPreviewExt(String viewExt) {}
        @Override public void setInputStreamFactory(ISeekableInputStreamFactory inputStreamFactory) {}
        @Override public void setIdInDataSource(String string) {}
        @Override public void setThumb(byte[] thumb) {}
    ...
    /**
     * IItem stub that does NOT have setMediaType(String), causing the
     * default setMediaType(Object) to throw UnsupportedOperationException.
     */
    ...
    /**
     * IItem stub that does NOT have setMetadata(Object), causing the
     * default setMetadata(Object) to throw UnsupportedOperationException.
     */
