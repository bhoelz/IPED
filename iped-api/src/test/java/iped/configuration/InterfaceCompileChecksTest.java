...
/**
 * Compile-check tests for configuration interfaces. Each test instantiates a minimal anonymous
 * implementation, confirming the interface contract is satisfied and that JaCoCo counts the
 * bytecode.
 */
class InterfaceCompileChecksTest {
  ...
  void iConfigurationDirectory_isImplementable() throws IOException {
    IConfigurationDirectory dir =
        new IConfigurationDirectory() {
