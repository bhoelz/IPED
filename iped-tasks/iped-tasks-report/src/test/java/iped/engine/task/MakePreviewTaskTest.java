...
/**
 * Tests for MakePreviewTask that are exercisable without the full AbstractTask lifecycle (no
 * ConfigurationManager, StandardParser, or case directory needed).
 */
