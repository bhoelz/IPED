...
/**
 * Covers the standalone (caseData == null) fallback of the carve tasks' accumulators: shared across
 * per-item task instances within a run, and cleared by finish() so successive standalone runs in
 * the same JVM start fresh (see BaseCarveTask.clearStandaloneAccum()).
 */
