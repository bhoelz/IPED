...
public class CarverTaskProvider implements TaskProvider<AbstractTask> {

    private static final String TASK_ID = "iped.engine.task.carver.CarverTask";
    ...
    public AbstractTask createTask() {
        return new CarverTask();
    }

    @Override
    public List<TaskDependency> dependencies() {
        return List.of(TaskDependency.after("iped.engine.task.carver.LedCarveTask"));
    }
}
