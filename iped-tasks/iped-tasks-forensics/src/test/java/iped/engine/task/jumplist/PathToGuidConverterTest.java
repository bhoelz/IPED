...
public class PathToGuidConverterTest {
  ...
  public void testProgramFilesPath() {
    ...
    assertThat(
        "Missing FOLDERID_ProgramFiles",
        result,
        hasItem("{905E63B6-C1BF-494E-B29C-65B732D3D21A}\\My App\\app.exe"));
    assertThat(
        "Missing FOLDERID_ProgramFilesX64",
        result,
        hasItem("{6D809377-6AF0-444b-8957-A3773F02200E}\\My App\\app.exe"));
    assertThat(
        "Missing FOLDERID_ProgramFilesX86",
        result,
        hasItem("{7C5A40EF-A0FB-4BFC-874A-C0F2E0B9FA8E}\\My App\\app.exe"));
  }
  ...
  public void testProgramFilesX86PathCaseInsensitive() {
    ...
    assertThat(
        "Missing FOLDERID_ProgramFiles (generic)",
        result,
        hasItem("{905E63B6-C1BF-494E-B29C-65B732D3D21A}\\My App\\app.exe"));
    assertThat(
        "Missing FOLDERID_ProgramFilesX86",
  ...
  public void testPublicDownloadsPath() {
    ...
    assertEquals(
        "Incorrect GUID for FOLDERID_PublicDownloads",
        "{3D644C9B-1FB8-4f30-9B45-F670235F79C0}\\installer.exe",
        result.get(0));
  }
  ...
  public void testUserProfileDesktopPath() {
    ...
    assertEquals(
        "Incorrect GUID for FOLDERID_Desktop",
        "{B4BFCC3A-DB2C-424C-B029-7FE99A87C641}\\shortcut.lnk",
        result.get(0));
  }
  ...
  public void testUserProfileGenericPath() {
    ...
    assertEquals(
        "Incorrect GUID for FOLDERID_Profile",
        "{5E6C858F-0E22-4760-9AFE-EA3317B67173}\\Documents\\doc.txt",
        result.get(0));
  }
  ...
  public void testWinDirSystem32Path() {
    ...
    assertThat(
        "Missing FOLDERID_System",
        result,
        hasItem("{1AC14E77-02E7-4E5D-B744-2EB1AE5198B7}\\cmd.exe"));
    assertThat(
        "Missing FOLDERID_SystemX86",
        result,
        hasItem("{D65231B0-B2F1-4857-A4CE-A8E7C6EA7D27}\\cmd.exe"));
  }
  ...
  public void testWinDirGenericPath() {
    ...
    assertEquals(
        "Incorrect GUID for FOLDERID_Windows",
  ...
  public void testLocalAppDataProgramsPath() {
    ...
    assertEquals(
        "Incorrect GUID for FOLDERID_UserProgramFiles",
        "{5CD7AEE2-2219-4A67-B85D-6C9CE15660CB}\\SomeApp\\app.exe",
        result.get(0));
  }
  ...
  public void testPathWithUnmappedEnvVar() {
    ...
    List<String> result = converter.pathsWithKnownFolderIds(path);
    assertThat(
        "Result list should be empty for unmapped environment variable", result, is(empty()));
  }
  ...
  public void testPathKeyWithTrailingSlash() {
    ...
    assertEquals("Should return 3 GUID paths for %PROGRAMFILES%\\", 3, result.size());
    assertThat(
        "Missing FOLDERID_ProgramFiles with trailing slash",
        result,
        hasItem("{905E63B6-C1BF-494E-B29C-65B732D3D21A}\\"));
  }
  ...
  public void testPathWithForwardSlashes() {
    ...
    assertThat(
        "Missing FOLDERID_ProgramFiles with forward slash",
        result,
        hasItem("{905E63B6-C1BF-494E-B29C-65B732D3D21A}/My App/app.exe"));
  }
}
