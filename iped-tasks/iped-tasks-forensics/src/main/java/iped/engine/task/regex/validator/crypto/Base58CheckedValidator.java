...
/**
 * Utility class for validation of Base58Checked values used in various cryptocurrencies
 *
...
public class Base58CheckedValidator {
  ...
  public byte[] decodeChecked(String input) throws IOException {
    ...
    if (tmp.length < 4) throw new IOException("Base58 AddressFormatException Input too short");
