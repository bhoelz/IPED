...
public class BitcoinAddressValidatorService extends BasicAbstractRegexValidatorService {
  ...
  private static int[] BECH32_CHARSET_REV = {
  ...
  private static int[] BECH32_GENERATOR = {
    0x3b6a57b2, 0x26508e6d, 0x1ea119fa, 0x3d4233dd, 0x2a1462b3
  };

  private static Bech32AddressValidator bech32validator =
      new Bech32AddressValidator(BECH32_CHARSET_REV, BECH32_GENERATOR);
  ...
  public List<String> getRegexNames() {
    return Arrays.asList(
        "CRYPTOCOIN_BITCOIN_ADDRESS",
        "CRYPTOCOIN_BITCOIN_BIP38_ENC_PRIV_K",
        "CRYPTOCOIN_BITCOIN_WIF_PRIV_K_UNC_PUB_K",
        "CRYPTOCOIN_BITCOIN_WIF_PRIV_K_COMP_PUB_K",
        "CRYPTOCOIN_BITCOIN_BIP32_HD_XPRV_KEY",
        "CRYPTOCOIN_BITCOIN_BIP32_HD_XPUB_KEY");
  }
