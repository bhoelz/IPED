...
/**
 * Validate BCH CashAddr format. Note that the legacy format follow the exact same rules as of
 * bitcoin address, so it's not possible to tell the difference (it will be validated as
 * BitcoinAddress)
 *
...
public class BCHAddressValidatorService extends BasicAbstractRegexValidatorService {
  ...
  private static long[] BECH32_BITCOIN_CASH_GENERATOR = {
