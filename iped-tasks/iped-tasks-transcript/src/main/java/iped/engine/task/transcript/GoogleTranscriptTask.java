...
public class GoogleTranscriptTask extends AbstractTranscriptTask {
  ...
  public void init(ConfigurationManager configurationManager) throws Exception {
    ...
    // caseData is null when running standalone (no case); nothing to opt out of.
  ...
  protected TextAndScore transcribeWavPart(File tmpFile) throws Exception {
    ...
    try {
      ...
      List<String> alternativeLangs =
          transcriptConfig.getLanguages().subList(1, transcriptConfig.getLanguages().size());
