...
public class GraphTask extends AbstractTask {
    ...
    private NodeValues writePersonNode(IItem item, SortedSet<String> msisdnPhones) throws IOException {
        ...
        possibleEmails
                .addAll(Arrays.asList(item.getMetadataValues(ExtraProperties.UFED_META_PREFIX + "EmailAddress")));
        possibleEmails
                .addAll(Arrays.asList(item.getMetadataValues(ExtraProperties.UFED_META_PREFIX + "Username")));
        possibleEmails.addAll(Arrays.asList(item.getMetadataValues(ExtraProperties.UFED_META_PREFIX + "UserID")));
        ...
        possiblePhones
                .addAll(Arrays.asList(item.getMetadataValues(ExtraProperties.UFED_META_PREFIX + "PhoneNumber")));
        possiblePhones
                .addAll(Arrays.asList(item.getMetadataValues(ExtraProperties.UFED_META_PREFIX + "Username")));
        ...
        if (name.length == 0)
            name = item.getMetadataValues(ExtraProperties.USER_NAME);
        ...
        if (org.length == 0)
            org = item.getMetadataValues(ExtraProperties.USER_ORGANIZATION);
        ...
        if (notes.length == 0)
            notes = item.getMetadataValues(ExtraProperties.USER_NOTES);
