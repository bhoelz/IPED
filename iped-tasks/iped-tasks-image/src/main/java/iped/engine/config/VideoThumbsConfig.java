...
public class VideoThumbsConfig extends AbstractTaskPropertiesConfig {
  ...
  /**
   * Max dimension size to use when extracting frames. Currently this has precedence over other
   * options.
   */
  private int maxDimensionSize = 1024;

  /** Javascript equation to compute number of extracted thumbs from video duration in seconds. */
