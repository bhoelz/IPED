...
class VideoThumbsOutputConfigTest {
  ...
  void constructor_setsBorder() {
    VideoThumbsOutputConfig cfg =
        new VideoThumbsOutputConfig(new File("x"), defaultVideoConfig(), 5);
  ...
  void setThumbSize_overridesVideoConfigSize() {
    VideoThumbsOutputConfig cfg =
        new VideoThumbsOutputConfig(new File("x"), defaultVideoConfig(), 0);
  ...
  void toString_containsFieldNames() {
    VideoThumbsOutputConfig cfg =
        new VideoThumbsOutputConfig(new File("test.jpg"), defaultVideoConfig(), 1);
