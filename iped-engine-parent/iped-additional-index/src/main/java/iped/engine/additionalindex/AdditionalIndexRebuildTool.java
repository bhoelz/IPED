...
/**
 * Rebuilds an additional store from projections already present in the case index. It never opens
 * or reprocesses original evidence content.
 */
public final class AdditionalIndexRebuildTool {
  ...
  public RebuildReport rebuild(
      ...
      Function<Integer, RebuildRecord> projection)
      throws IOException {
