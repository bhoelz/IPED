 ...
 *
 * <p>These tests verify that multiple GraphService instances can coexist independently for
 * different database folders.
 */
public class GraphServiceFactoryImplTest {
  ...
  void testMultipleGraphServicesByFolder() {
    ...
    assertNotSame(
        service1, service2, "Services for different folders should be different instances");
  }
