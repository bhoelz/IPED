...
class GraphConstantsTest {
    ...
    void dbDataPath_combinesHomeDirAndDataDir() {
        assertEquals(GraphConstants.DB_HOME_DIR + "/" + GraphConstants.DB_DATA_DIR,
                GraphConstants.DB_DATA_PATH);
    ...
    void csvsPath_combinesHomeDirAndCsvsDir() {
        assertEquals(GraphConstants.DB_HOME_DIR + "/" + GraphConstants.CSVS_DIR,
                GraphConstants.CSVS_PATH);
