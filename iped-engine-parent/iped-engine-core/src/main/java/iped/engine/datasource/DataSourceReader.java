 ...
 * relatório do UFED, caso do iped). Pode ser estendida para implementar suporte a uma nova fonte de
...
public abstract class DataSourceReader implements Closeable {
   ...
   */
  public void read(File datasource, IItem parent) throws Exception {
    throw new IllegalAccessException(
        "Method read(File datasource, EvidenceFile parent) not implemented in class "
   ...
   *     em que o processamento só possa ser iniciado após a adição, possivelmente lenta, de todos
   *     os itens (ex: sleuthkit).
   */
