 ...
 *
 * iped-engine's Manager registers itself here at startup. Datasource modules
 * (iped-sleuthkit, iped-ufed, iped-ad1) call DatasourceRegistry.get() to
 * obtain the registered implementation.
 */
public final class DatasourceRegistry {
    ...
    public static IDatasourceRegistry get() {
        if (instance == null) {
            throw new IllegalStateException("DatasourceRegistry has not been initialized. "
