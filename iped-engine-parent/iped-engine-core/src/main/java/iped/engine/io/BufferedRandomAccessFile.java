 ...
 *
 * <p>This is an optimized version of the RandomAccessFile class as described by Nick Zhang on
...
public class BufferedRandomAccessFile extends RandomAccessFile {
   ...
   *     an existing, writable regular file and a new regular file of that name cannot be created,
   ...
   *     existing regular file, or if the mode begins with "rw" but the given file path does not
   *     denote an existing, writable regular file and a new regular file of that name cannot be
