...
public class UFEDXMLWrapper extends Reader {
  ...
  private static final Pattern invalidPattern =
      Pattern.compile(
          "(&#x0;)|(&#x1;)|(&#x2;)|(&#x3;)|(&#x4;)|(&#x5;)|(&#x6;)|(&#x7;)|(&#x8;)|"
              + "(&#xB;)|(&#xC;)|(&#xE;)|(&#xF;)|(&#x10;)|(&#x11;)|(&#x12;)|(&#x13;)|(&#x14;)|(&#x15;)|(&#x16;)|(&#x17;)|(&#x18;)|(&#x19;)|"
              + "(&#x1A;)|(&#x1B;)|(&#x1C;)|(&#x1D;)|(&#x1E;)|(&#x1F;)");
  ...
  public UFEDXMLWrapper(InputStream xml)
  ...
  private void escapeInvalidChars() {
    ...
    if (inModel && inData) {
      ...
      if (idx != -1 && buffer.indexOf(cDataStart) != idx + prefix.length()) {
        buffer =
            buffer.substring(0, idx + prefix.length())
                + cDataStart
      ...
      if (buffer.contains("&#x")) buffer = invalidPattern.matcher(buffer).replaceAll("?");
    }

    if (buffer.contains("<model type=\"Password\" ")) inModel = true;

    if (buffer.contains("</model>")) inModel = false;

    if (buffer.contains("<field name=\"Data\" type=\"String\">")) inData = true;

    if (buffer.contains("</field>")) inData = false;
  }
