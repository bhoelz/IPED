...
/**
 * Generates JSON Schema and UI Schema for Configurable components. Uses JSON Schema Draft 2020-12
...
public class ConfigurableSchemaGenerator {
  ...
  /**
   * Generate UI Schema for a Configurable component. Uses JSON Form / react-jsonschema-form
   * conventions.
   *
   * @param info ConfigurableSchemaInfo containing component metadata
  ...
  /**
   * Analyze a Configurable class and extract its schema information. This is a helper method that
   * can be overridden for specific component types.
   *
  ...
  public ConfigurableSchemaInfo analyzeConfigurable(Class<?> configurableClass) {
    ...
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo(className, configurableClass.getName());
