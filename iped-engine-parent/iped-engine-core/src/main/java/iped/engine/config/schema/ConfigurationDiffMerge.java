...
/**
 * Utilities for comparing and merging configurations. Provides diff detection and conflict-aware
 * merging.
 */
public class ConfigurationDiffMerge {
  ...
  public static class ConfigurationDiff {
    ...
    public Map<String, JsonNode> getAdded() {
      return added;
    }

    public Map<String, JsonNode> getRemoved() {
      return removed;
    }

    public Map<String, FieldChange> getModified() {
      return modified;
    }
  ...
  public static class MergeResult {
    ...
    public ObjectNode getMergedConfig() {
      return mergedConfig;
    }

    public Map<String, JsonNode> getApplied() {
      return applied;
    }

    public Map<String, String> getAppliedFrom() {
      return appliedFrom;
    }

    public Map<String, ConflictInfo> getConflicts() {
      return conflicts;
    }
