...
/**
 * Command-line tool for validating all JSON schemas.
 * Validates schemas against JSON Schema specification and checks for completeness.
 */
public class SchemaValidationCLI {
    ...
    public void validateAllSchemas() {
        ...
        String[] configSchemas = {
            "TaskInstallerConfig", "ParsersConfig", "ExternalParsersConfig", "AnalysisConfig",
            "OCRConfig", "FileSystemConfig", "LocalConfig", "PluginConfig",
            "ProcessingPriorityConfig", "IndexTaskConfig", "ElasticSearchTaskConfig",
            "HashTaskConfig", "ImageThumbTaskConfig", "VideoThumbsConfig", "AudioTranscriptConfig",
            "RegexTaskConfig", "NamedEntityTaskConfig", "CategoryConfig", "SignatureConfig",
            "MakePreviewConfig", "RemoteImageClassifierConfig", "AIFiltersConfig",
            "PhotoDNAConfig", "PhotoDNALookupConfig", "ExportByCategoriesConfig",
            "ParsingTaskConfig", "TempFileTaskConfig", "DocThumbTaskConfig",
            ...
            "HtmlReportTaskConfig", "AppIDsConfig", "CarverTaskConfig", "GraphTaskConfig",
            "MapPanelConfig", "AbstractPropertiesConfigurable"
        };
        ...
        String[] cliSchemas = {
            "IPEDProcessingCLI", "IPEDWebAPICLI", "IPEDSearchAppCLI"
        };
    ...
    public void printReport() {
        ...
        System.out.println("Total: " + (validSchemas.size() + invalidSchemas.size() + missingSchemas.size()));
        ...
        System.out.println("\nValidation " + (invalidSchemas.isEmpty() && missingSchemas.isEmpty() ? "PASSED" : "FAILED"));
    }
