...
/**
 * Embedded Jetty server for Configuration API. Starts JAX-RS/Jersey service on configurable port.
 */
@Slf4j
public class ConfigurationServer {
  ...
  public void start() throws Exception {
    ...
    jerseyServlet.setInitParameter(
        "jersey.config.server.provider.packages", "iped.engine.config.api");
    jerseyServlet.setInitParameter(
