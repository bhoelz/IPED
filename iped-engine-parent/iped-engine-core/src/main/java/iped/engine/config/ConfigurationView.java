...
/**
 * Provides a case-specific view of configuration by wrapping the global ConfigurationManager and
 * allowing case-specific path overrides.
 *
 * <p>This enables multiple cases to run with different output directories, temporary directories,
 * and other case-specific configuration without reloading or interfering with the global
