...
/**
 * Generates CLI help text from JSON schemas. Produces formatted help documentation for command-line
 * arguments.
 */
public class CLIHelpGenerator {
  ...
  private String formatArgument(JsonNode schema, String fieldName, boolean required) {
    ...
    String description =
        prop.has("description") ? prop.get("description").asText() : "No description";
