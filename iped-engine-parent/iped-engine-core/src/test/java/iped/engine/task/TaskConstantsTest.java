...
class TaskConstantsTest {
    ...
    void taskRuntime_invokeVideoScore_unknownClass_returnsFallback() {
        double result = TaskRuntime.invokeVideoScore("iped.engine.task.NonExistentClass",
                java.util.Map.of(), 3.14);
        assertEquals(3.14, result, 1e-9);
    }

    @Test
    void taskRuntime_invokeVideoScoreList_unknownClass_returnsFallback() {
        double result = TaskRuntime.invokeVideoScoreList("iped.engine.task.NonExistentClass",
                java.util.List.of(), 2.71);
        assertEquals(2.71, result, 1e-9);
    }

    @Test
    void taskRuntime_invokeConstructedVoid_unknownClass_swallowsThrowable() {
        TaskRuntime.invokeConstructedVoid("iped.engine.task.NonExistentClass",
                String.class, "arg", "method", String.class, "param");
    }
