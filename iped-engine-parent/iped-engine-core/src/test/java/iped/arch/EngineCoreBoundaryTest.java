...
/**
 * Ensures iped-engine-core does not depend on sibling modules within iped-engine-parent. It may
 * only depend on iped-api, iped-utils, and third-party libraries.
 *
 * <p>Violations indicate logic that belongs in a higher layer (orchestration → iped-engine) or a
 * datasource-specific module.
 */
  ...
  void engineCoreMustNotImportSleuthkitTypes() {
    ArchRule rule =
        noClasses()
            ...
            .because(
                "iped-engine-core must have zero datasource-specific imports; "
  ...
  void engineCoreMustNotContainOrchestrationLogic() {
    ArchRule rule =
        noClasses()
            ...
            .because(
                "orchestration logic (Manager) and Lucene indexing belong in iped-engine, "
