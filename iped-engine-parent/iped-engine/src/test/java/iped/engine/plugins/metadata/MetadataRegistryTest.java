...
public class MetadataRegistryTest {
  ...
  public void testRegisterProperty() {
    MetadataPropertyDescriptor prop =
  ...
  public void testGetProperty() {
    MetadataPropertyDescriptor prop =
        new MetadataPropertyDescriptor(
            "test.name", "Test Name", "string", true, false, "standard", "test", "component");
  ...
  public void testDuplicatePropertyRegistration() {
    MetadataPropertyDescriptor prop1 =
        new MetadataPropertyDescriptor(
            "dup.property", "Display 1", "string", true, false, "standard", "cat1", "comp1");
    MetadataPropertyDescriptor prop2 =
        new MetadataPropertyDescriptor(
            "dup.property", "Display 2", "integer", false, true, "keyword", "cat2", "comp2");
  ...
  public void testPropertyTypeValidation() {
    MetadataPropertyDescriptor prop =
        new MetadataPropertyDescriptor(
            "type.test", "Type Test", "string", true, false, "standard", "cat", "comp");
  ...
  public void testDataTypes() {
    ...
    for (int i = 0; i < dataTypes.length; i++) {
      MetadataPropertyDescriptor prop =
          new MetadataPropertyDescriptor(
              "type." + i, "Type " + i, dataTypes[i], true, false, "standard", "cat", "comp");
      registry.registerProperty(prop);
    }
  ...
  public void testPropertyComparison() {
    MetadataPropertyDescriptor prop1 =
        new MetadataPropertyDescriptor(
            "same.name", "Display 1", "string", true, false, "standard", "cat1", "comp1");
    MetadataPropertyDescriptor prop2 =
        new MetadataPropertyDescriptor(
            "same.name", "Display 2", "integer", false, true, "keyword", "cat2", "comp2");
