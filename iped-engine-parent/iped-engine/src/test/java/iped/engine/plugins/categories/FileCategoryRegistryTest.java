...
public class FileCategoryRegistryTest {
  ...
  public void testGetCategoryInfo() {
    registry.registerCategory(
        "Forensic/Windows/Registry", "Registry Hive", "reg-icon", "Registry hive files", "comp1");

    FileCategoryRegistry.CategoryDescriptor desc =
        registry.getCategoryInfo("Forensic/Windows/Registry");
    assertNotNull(desc);
