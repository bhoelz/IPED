 ...
 *
 * <p>These tests verify that property change events are routed to case-specific listeners when in a
 * multi-case context, while maintaining backward compatibility with global listeners.
 */
