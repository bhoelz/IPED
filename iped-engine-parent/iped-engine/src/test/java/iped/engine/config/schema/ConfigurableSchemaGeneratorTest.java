...
class ConfigurableSchemaGeneratorTest {
  ...
  void testGenerateBasicJsonSchema() {
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo("TestConfig", "com.example.TestConfig");
  ...
  void testGenerateJsonSchemaWithProperties() {
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo("ConfigWithProps", "com.example.ConfigWithProps");
  ...
  void testGenerateJsonSchemaWithRequired() {
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo("RequiredPropsConfig", "com.example.RequiredPropsConfig");
  ...
  void testGenerateUiSchema() {
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo("UITestConfig", "com.example.UITestConfig");
  ...
  void testGeneratePropertySchemaWithEnumValues() {
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo("EnumConfig", "com.example.EnumConfig");
  ...
  void testSchemaJsonSchemaVersion() {
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo("VersionTest", "com.example.VersionTest");
    ObjectNode schema = generator.generateJsonSchema(info);
  ...
  void testSchemaIdGeneration() {
    ConfigurableSchemaInfo info =
        new ConfigurableSchemaInfo("MyComponent", "com.example.MyComponent");
    ObjectNode schema = generator.generateJsonSchema(info);
