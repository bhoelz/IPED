...
public final class ParsingTaskContextFactory {
  ...
  public static ParseContext create(
    ...
    Object expander =
        cls.getConstructor(IItem.class, StandardParser.class).newInstance(item, parser);
  ...
  public static ParseContext create(
    ...
    ParseContext context =
        (ParseContext) cls.getMethod("getTikaContext", IPEDSource.class).invoke(expander, source);
    cls.getMethod("setExtractEmbedded", boolean.class).invoke(expander, extractEmbedded);
    return context;
  }
}
