...
public class ImageSimilarity {
  ...
  private final BufferedImage auxColorImg =
      new BufferedImage(maxDim, maxDim, BufferedImage.TYPE_INT_BGR);
  private final BufferedImage auxGrayImg =
      new BufferedImage(maxDim, maxDim, BufferedImage.TYPE_BYTE_GRAY);
  private int w, h;
  ...
  private void getPixels(BufferedImage img) {
    ...
    gColor.setRenderingHint(
        RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_BILINEAR);
    gGray.setRenderingHint(
        RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_BILINEAR);
