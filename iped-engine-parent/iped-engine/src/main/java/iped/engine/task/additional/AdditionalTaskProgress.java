...
/**
 * Immutable snapshot of the progress of an additional-processing run. Instances are delivered to
 * the progress callback registered with {@link AdditionalTaskRunner#run}.
 */
