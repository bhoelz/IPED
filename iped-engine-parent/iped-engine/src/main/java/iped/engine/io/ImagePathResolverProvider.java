 ...
 *
 * <p>The engine defaults to a no-op resolver (returns {@code null}) so it can
 * run fully headless. iped-app registers its Swing implementation during
 * startup when a GUI is available.</p>
 */
