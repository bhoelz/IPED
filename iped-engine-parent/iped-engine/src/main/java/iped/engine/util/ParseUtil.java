...
public class ParseUtil {
  ...
  public static final Date parseDate(String strDateTime) throws DateFormatException {
    ...
    try {
      calendar.set(
          Integer.parseInt(strDateTime.substring(6, 10)),
          Integer.parseInt(strDateTime.substring(3, 5)) - 1,
          Integer.parseInt(strDateTime.substring(0, 2)),
          Integer.parseInt(strDateTime.substring(11, 13)),
          Integer.parseInt(strDateTime.substring(14, 16)),
