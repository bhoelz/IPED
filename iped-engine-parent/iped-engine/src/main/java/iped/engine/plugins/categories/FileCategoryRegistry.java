 ...
 *
 * <p>Manages registration of file categories with hierarchical structure, allowing plugins to
 * organize forensic artifacts into logical categories.
 *
...
public class FileCategoryRegistry {
  ...
  public void registerCategory(
      String path, String displayName, String icon, String description, String componentId) {
  ...
  public CategoryDescriptor getCategory(String path) {
    ...
    return new CategoryDescriptor(
        node.path, node.displayName, node.icon, node.description, node.componentId);
  }
  ...
  public List<String> getRootCategories() {
    return root.children.values().stream().map(n -> n.path).collect(Collectors.toList());
  }
  ...
  public List<String> getSubcategories(String parentPath) {
    ...
    return parent.children.values().stream().map(n -> n.path).collect(Collectors.toList());
  }
  ...
  public record CategoryHierarchy(
      String rootPath, List<String> children, Map<String, Object> metadata) {}
