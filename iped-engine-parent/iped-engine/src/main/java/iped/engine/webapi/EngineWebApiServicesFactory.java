...
public class EngineWebApiServicesFactory implements WebApiServicesFactory {
    ...
    static class EngineWebApiServices implements WebApiServices {
        ...
        private final ViewerSessionService viewerSessions = new EngineViewerSessionService(sources, renditions);
    ...
    static class EngineRenditionService implements RenditionService {
        ...
        @Override
        public List<RenditionDescriptor> available(String sourceId, int itemId, String mimeType, String baseUrl) {
        ...
        @Override
        public void writeRendition(String sourceId, int itemId, String kind, int page, int width, OutputStream out)
                throws Exception {
            IIPEDSource source = sources.getSourceHandle(sourceId);
            ...
            RenderRequest req = RenderRequest.builder(item, mimeType, renditionKind)
                    .page(page)
                    .widthHint(width)
                    .build();
    ...
    static class EngineViewerSessionService implements ViewerSessionService {
        ...
        @Override
        public Map<String, Object> openSession(String sourceId, int itemId, String mimeType,
            ...
            List<RenditionDescriptor> renditionList = renditions.available(sourceId, itemId, mimeType, baseUrl);
