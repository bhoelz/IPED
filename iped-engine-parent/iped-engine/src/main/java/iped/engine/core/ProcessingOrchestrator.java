...
public class ProcessingOrchestrator {
     ...
     */
    public synchronized static ProcessingOrchestrator getInstance() {
        if (instance == null) {
     ...
     */
    public synchronized static void initialize(int maxConcurrentCases, long maxMemoryPerCase) {
    ...
    private void processQueue() {
        while (running) {
            try {
                ...
                if (request != null && resourceManager.getActiveCaseCount() < resourceManager
                        .getMaxConcurrentCases()) {
                    try {
