...
public class HashDB {
  public static final String[] hashTypes =
      new String[] {"MD5", "SHA1", "SHA256", "SHA512", "EDONKEY"};
  ...
  static {
    ...
    zeroLengthHash[2] =
        hashStrToBytes("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
    zeroLengthHash[3] =
        hashStrToBytes(
