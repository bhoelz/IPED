...
class ItemStatusEventTest {
  ...
  void error_typeIsError() {
    ItemStatusEvent e =
        ItemStatusEvent.error(sampleMsg(), "HashTask", 100L, new RuntimeException("fail"));
  ...
  void error_errorMessageSet() {
    ItemStatusEvent e =
        ItemStatusEvent.error(sampleMsg(), "HashTask", 100L, new RuntimeException("disk full"));
  ...
  void error_errorClassSet() {
    ItemStatusEvent e =
        ItemStatusEvent.error(sampleMsg(), "HashTask", 100L, new IllegalStateException("oops"));
