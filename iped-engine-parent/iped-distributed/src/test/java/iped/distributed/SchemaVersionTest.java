 ...
 *
 * <ul>
 *   <li>All factory methods stamp {@link ItemStatusEvent#SCHEMA_VERSION}.
 *   <li>JSON serialization includes {@code schemaVersion}.
 *   <li>Deserialization of legacy events (no {@code schemaVersion}) yields {@code 0}.
 *   <li>Deserialization of current events round-trips correctly.
 *   <li>Future version events are accepted (forward-compat via {@code @JsonIgnoreProperties}).
 *   <li>{@link ItemStatusConsumer#validateSchemaVersion} does not throw for any version.
 * </ul>
 *
...
class SchemaVersionTest {
  ...
  void errorSetsCurrentVersion() {
    ItemStatusEvent e =
        ItemStatusEvent.error(sampleMsg, "HashTask", 10, new RuntimeException("boom"));
    assertEquals(ItemStatusEvent.SCHEMA_VERSION, e.getSchemaVersion());
  }
  ...
  void timeoutSetsCurrentVersion() {
    ItemStatusEvent e =
        ItemStatusEvent.timeout("case-test", UUID.randomUUID().toString(), "HashTask", 1, 120_000L);
    assertEquals(ItemStatusEvent.SCHEMA_VERSION, e.getSchemaVersion());
  }
  ...
  void serializedJsonContainsSchemaVersionField() throws Exception {
    ...
    assertTrue(
        json.contains("\"schemaVersion\""), "schemaVersion must appear in the serialized JSON");
  }
  ...
  void legacyEventWithoutSchemaVersionDeserializesToZero() throws Exception {
    ...
    String legacyJson =
        "{\"type\":\"COMPLETED\",\"caseId\":\"case-old\","
  ...
  void legacyEventWithExplicitZeroVersion() throws Exception {
    String json =
        "{\"schemaVersion\":0,\"type\":\"ERROR\",\"caseId\":\"c\","
  ...
  void futureVersionEventDeserializesSuccessfully() throws Exception {
    ...
    String futureJson =
        "{\"schemaVersion\":99,\"type\":\"COMPLETED\","
  ...
  void futureVersionDoesNotThrowDuringValidation() throws Exception {
    String futureJson =
        "{\"schemaVersion\":999,\"type\":\"STARTED\","
            + "\"caseId\":\"c\",\"itemUuid\":\"u\","
  ...
  void validateDoesNotThrowForLegacyVersion() throws Exception {
    String json =
        "{\"schemaVersion\":0,\"type\":\"COMPLETED\","
            + "\"caseId\":\"c\",\"itemUuid\":\"u\","
  ...
  void validateDoesNotThrowForFutureVersion() throws Exception {
    String json =
        "{\"schemaVersion\":9999,\"type\":\"SKIPPED\","
            + "\"caseId\":\"c\",\"itemUuid\":\"u\","
            + "\"timestamp\":\"2026-06-01T00:00:00Z\"}";
    ItemStatusEvent event = MAPPER.readValue(json, ItemStatusEvent.class);
    assertDoesNotThrow(() -> ItemStatusConsumer.validateSchemaVersion(event));
  ...
  void unknownEventTypeDeserializesToNullType() throws Exception {
    ...
    String json =
        "{\"schemaVersion\":2,\"type\":\"FUTURE_TYPE\","
            + "\"caseId\":\"c\",\"itemUuid\":\"u\","
            + "\"timestamp\":\"2026-12-01T00:00:00Z\"}";
