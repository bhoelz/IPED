...
class ItemConverterTest {
  ...
  void attrConstants_startWithDoubleUnderscore() {
    ...
    assertTrue(
        ItemConverter.ATTR_KAFKA_MSG.startsWith("__"), "ATTR_KAFKA_MSG should start with '__'");
    assertTrue(
        ItemConverter.ATTR_OUTPUT_TOPIC.startsWith("__"),
        "ATTR_OUTPUT_TOPIC should start with '__'");
    assertTrue(
        ItemConverter.ATTR_RAW_TOPIC.startsWith("__"), "ATTR_RAW_TOPIC should start with '__'");
    assertTrue(
        ItemConverter.ATTR_ITEM_UUID.startsWith("__"), "ATTR_ITEM_UUID should start with '__'");
  }
