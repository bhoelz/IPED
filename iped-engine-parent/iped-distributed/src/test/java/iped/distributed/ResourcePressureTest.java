...
class ResourcePressureTest {
    ...
    void policyRejectsDiskSoftBelowHard() {
        assertThrows(IllegalArgumentException.class,
                () -> new ResourcePressurePolicy(0.75, 0.90, 4_000, 5_000));
    }
    ...
    void enginePressureAloneRaisesHard() {
        ...
        ResourcePressureMonitor monitor = new ResourcePressureMonitor(
                policy,
    ...
    private static ResourcePressureMonitor monitorWithHeap(
        ...
        ResourcePressurePolicy policy = new ResourcePressurePolicy(
                softThreshold, hardThreshold, 10_000L, 5_000L);
        long max = 1_000L;
        long used = (long) (heapRatio * max);
        return new ResourcePressureMonitor(policy,
    ...
    private static ResourcePressureMonitor monitorWithDisk(
        ...
        ResourcePressurePolicy policy = new ResourcePressurePolicy(
                0.75, 0.90, softThreshold, hardThreshold);
        return new ResourcePressureMonitor(policy,
