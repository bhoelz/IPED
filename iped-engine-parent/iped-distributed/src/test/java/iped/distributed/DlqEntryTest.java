...
class DlqEntryTest {
    ...
    void originalTopicStripsDefaultSuffix() {
        assertEquals("iped.case1.stage.2",
                DlqEntry.originalTopic("iped.case1.stage.2.dlq", ".dlq"));
    }

    @Test
    void originalTopicWorksWithCustomSuffix() {
        assertEquals("iped.case2.stage.0",
                DlqEntry.originalTopic("iped.case2.stage.0-dead", "-dead"));
    }
    ...
    void originalTopicThrowsWhenSuffixAbsent() {
        assertThrows(IllegalArgumentException.class,
                () -> DlqEntry.originalTopic("iped.case1.stage.2", ".dlq"));
    }

    @Test
    void originalTopicThrowsOnNullTopic() {
        assertThrows(IllegalArgumentException.class,
                () -> DlqEntry.originalTopic(null, ".dlq"));
    }
