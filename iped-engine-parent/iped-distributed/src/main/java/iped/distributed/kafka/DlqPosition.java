 ...
 *
 * <p>Used as a request body element for
 * {@link DlqManager#requeue} and {@link DlqManager#discard}:
 * the operator obtains positions from a prior {@link DlqManager#list} call and
 * passes them back to select which items to replay or write off.
 *
 * <p>All three fields together form a unique key: the message at exactly
 * {@code (dlqTopic, partition, offset)}.
 */
...
public class DlqPosition {
    ...
    public String toString() {
        return "DlqPosition{topic='" + dlqTopic + "', partition=" + partition
                + ", offset=" + offset + '}';
    }
}
