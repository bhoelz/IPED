 ...
 *
 * <p>Events are appended via {@link #append} and read via {@link #latest}.  When the
 * buffer is full the oldest entry is silently overwritten.  Thread-safe.
 *
...
public class CoordinatorEventLog {
    ...
    /**
     * Returns the most recent {@code n} events, oldest-first.  If fewer than {@code n}
     * events have been recorded, all recorded events are returned.
     */
