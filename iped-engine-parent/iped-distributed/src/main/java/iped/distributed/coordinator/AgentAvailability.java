...
/**
 * Aggregated availability for all agents of a given task type.
 * Returned by {@code GET /api/v1/agents/availability}.
 */
...
public class AgentAvailability {
    ...
    public static AgentAvailability of(String taskType, int stageNumber,
                                        int totalAgents, int totalSlots, int freeSlots) {
    ...
    public void setTotalAgents(int v)   { totalAgents = v; }
    public void setTotalSlots(int v)    { totalSlots = v; }
    public void setFreeSlots(int v)     { freeSlots = v; }
    public void setBusySlots(int v)     { busySlots = v; }
}
