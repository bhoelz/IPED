...
/**
 * Snapshot of a Task Agent's identity and current capacity. Published on registration and refreshed
 * on each heartbeat.
 */
...
public class AgentRegistration {
  ...
  public static AgentRegistration of(
      String agentId, String taskType, int stageNumber, int maxParallelItems, String hostname) {
  ...
  public int getMaxParallelItems() {
    return maxParallelItems;
  }

  public void setMaxParallelItems(int v) {
    maxParallelItems = v;
  }
  ...
  public void setCurrentLoad(int v) {
    currentLoad = v;
  }
  ...
  public void setLastHeartbeat(Instant v) {
    lastHeartbeat = v;
  }
  ...
  public void setPressureLevel(PressureLevel v) {
    pressureLevel = v;
  }
  ...
  public void setPressureRatio(double v) {
    pressureRatio = v;
  }
}
