...
/**
 * A single attribute discrepancy for an item that exists in both paths but whose metadata does not
 * agree.
 *
 ...
 */
public record AttributeMismatch(
    String path, String field, String distributedValue, String referenceValue) {}
