...
/**
 * Output of the {@link CaseScheduler}: how many free agent slots of a task type should
 * next be directed at a given case.  Assignments target <b>free</b> capacity only and
 * never reduce a case's in-flight work.
 *
