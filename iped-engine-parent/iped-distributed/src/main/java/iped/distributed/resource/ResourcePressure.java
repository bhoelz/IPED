...
/**
 * A point-in-time snapshot of an agent's resource state, produced by
 * {@link ResourcePressureMonitor#sample()}.
 *
 ...
 * @param engineUnderPressure true when the engine's {@code ResourceManager} reports a
 *                            case paused for resource reasons
