...
public record ResourcePressurePolicy(
        double heapSoftRatio,
        double heapHardRatio,
        long   diskSoftFreeBytes,
        long   diskHardFreeBytes
) {
    ...
    public static ResourcePressurePolicy defaults() {
        return new ResourcePressurePolicy(0.75, 0.90,
                10L * 1024 * 1024 * 1024, 5L * 1024 * 1024 * 1024);
    }
