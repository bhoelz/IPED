 ...
 *
 * <p>Defaults to the OpenStreetMap public tile server. For air-gapped labs, set
 * {@code iped.webui.map.tile-url} to a local tile server URL (e.g. a
 * self-hosted TileServer-GL or MapProxy instance).
 *
...
public class WebMapProperties {
    ...
    private String tileAttribution = "&copy; <a href=\"https://www.openstreetmap.org/copyright\">OpenStreetMap</a> contributors";
    ...
    public String getTileAttribution() { return tileAttribution; }
    public void setTileAttribution(String tileAttribution) { this.tileAttribution = tileAttribution; }
