...
public class WorkspaceCapabilitiesController {
    ...
    public Map<String, Boolean> capabilities() {
        return Map.of("bookmarks", properties.isBookmarksEnabled(),
                "viewerSearch", properties.isViewerSearchEnabled(),
                "export", properties.isExportEnabled(),
                "companionFallback", properties.isCompanionFallbackEnabled());
    }
}
