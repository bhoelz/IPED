...
public class WebApiClientTest {
  ...
  static void startServer() throws IOException {
    routes.put("/v2/cases", new StubResponse(200, "{\"cases\":[{\"id\":\"c1\"},{\"id\":\"c2\"}]}"));
    routes.put("/v2/cases/my%20case", new StubResponse(200, "{\"id\":\"my case\"}"));
    routes.put(
        "/v2/search",
        new StubResponse(200, "{\"total\":2,\"offset\":0,\"limit\":20,\"items\":[]}"));
    routes.put("/v2/bookmarks", new StubResponse(200, "{\"bookmarks\":[\"tag1\",\"tag2\"]}"));
    routes.put("/v2/sources/src1/items/7/text", new StubResponse(200, "hello world"));
    routes.put(
        "/v2/sources/src1/items/8",
        new StubResponse(
            200,
            "{\"itemId\":\"src1:8\",\"name\":\"doc.txt\",\"mediaType\":\"text/plain\",\"size\":100}"));
    routes.put(
        "/v2/sources/src1/items/categories", new StubResponse(200, "[\"Images\",\"Documents\"]"));
    // 4xx/5xx
    routes.put("/v2/cases/missing", new StubResponse(404, ""));
    ...
    server.createContext(
        ...
        exchange -> {
          ...
          lastRequests.put(
              rawPath, exchange.getRequestMethod() + " " + exchange.getRequestURI().getRawQuery());
