 ...
 *
 * <p>Parsed from {@code --capabilities=bookmarks,jobs}. The default (no flag)
 * is read-only — no mutating tools are registered.
 *
 * <ul>
 *   <li>{@link #BOOKMARKS} — enables bookmark/tag write tools</li>
 *   <li>{@link #JOBS}      — enables async job tools (export, report)</li>
 * </ul>
 */
