 ...
 *
 * <ul>
 *   <li>{@code iped_item_get} — full metadata for one item
 *   <li>{@code iped_item_preview} — extracted text, prompt-safe wrapped
 *   <li>{@code iped_item_related} — related items (subitems, parent, duplicates, …)
 *   <li>{@code iped_category_list} — available categories for a source
 * </ul>
 */
    ...
    var props =
        Map.<String, Object>of(
            ...
            Map.of(
                ...
                "string",
                "description",
                "Composite item ID in \"{sourceId}:{docId}\" format, "
        ...
        Map.<String, Object>of(
            ...
            "highlight",
                Map.of(
                    ...
                    "string",
                    "description",
                    "(Optional) Space-separated terms to highlight in the output"));
    var schema = new McpSchema.JsonSchema("object", props, List.of("itemId"), null, null, null);
    return McpServerFeatures.SyncToolSpecification.builder()
        .tool(
            McpSchema.Tool.builder()
        ...
        .callHandler(
            (exchange, request) -> {
              ...
              String itemId = (String) args.get("itemId");
              String highlight =
                  args.containsKey("highlight") ? (String) args.get("highlight") : "";
              try {
                var ref = parseItemId(itemId);
                ...
                if (isBinary(mediaType)) {
                  ...
                  wrapped =
                      EvidenceGuard.binaryPlaceholder(ref.sourceId(), itemId, mediaType, size);
                } else {
        ...
        Map.<String, Object>of(
            ...
            "relation",
                Map.of(
                    ...
                    RELATIONS,
                    "description",
                    "Relationship to traverse: subitems (children of a container), "
            ...
            "limit",
                Map.of("type", "integer", "description", "Max items to return, 1–50 (default 20)"));
    var schema =
        new McpSchema.JsonSchema("object", props, List.of("itemId", "relation"), null, null, null);
    return McpServerFeatures.SyncToolSpecification.builder()
        .tool(
            McpSchema.Tool.builder()
            ...
            (exchange, request) -> {
              ...
              int limit =
                  args.containsKey("limit")
                      ? Math.min(((Number) args.get("limit")).intValue(), 50)
                      : 20;
              ...
              try {
                var ref = parseItemId(itemId);
                var result =
                    client.getRelatedItems(ref.sourceId(), ref.docId(), relation, offset, limit);
  ...
  private McpServerFeatures.SyncToolSpecification categoryList() {
    var props =
        Map.<String, Object>of(
            "sourceId",
            Map.of(
                "type", "string", "description", "Source ID from iped_case_list (e.g. \"src0\")"));
