 ...
 *
 * <ul>
 *   <li>{@code iped_search} — paginated Lucene search with opaque cursor tokens</li>
 * </ul>
 *
 * <h2>Pagination</h2>
 * <p>Responses include a {@code nextCursor} field when more results exist. Pass
 * the cursor back as the {@code cursor} parameter to retrieve the next page
 * without tracking offset/limit arithmetic. Raw {@code offset}/{@code limit}
 * are still accepted for direct access.
 */
public class SearchTools {
    ...
    private McpServerFeatures.SyncToolSpecification search() {
        var props = Map.<String, Object>of(
                ...
                "cursor", Map.of("type", "string",
                        "description", "(Optional) Opaque cursor returned as nextCursor in a previous " +
        ...
        return McpServerFeatures.SyncToolSpecification.builder()
                ...
                .callHandler((exchange, request) -> {
                    ...
                    if (args.containsKey("cursor") && args.get("cursor") != null
                    ...
                    try {
                        ...
                        audit.success("iped_search", Map.of("query", query,
    ...
    static String encodeCursor(String query, int offset, int limit) throws Exception {
        String json = MAPPER.writeValueAsString(
                Map.of("q", query, "o", offset, "l", limit));
