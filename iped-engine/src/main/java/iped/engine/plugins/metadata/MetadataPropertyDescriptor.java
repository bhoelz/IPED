 ...
 *
 * Properties define what metadata can be attached to items, including:
 * - Name and display name
 * - Data type (for serialization/deserialization)
 * - Indexing configuration (for Elasticsearch)
...
public record MetadataPropertyDescriptor(
    ...
    public static boolean isValidDataType(String type) {
        return type.equals("date") || type.equals("boolean") || type.equals("integer") ||
               type.equals("string") || type.equals("decimal");
    }
