...
public class AudioViewer extends AbstractViewer {
  ...
  ;
  private static final String audioDurationAttr =
      ExtraProperties.AUDIO_META_PREFIX + "xmpDM:duration";
          ...
          public void run() {
            ...
            if (content instanceof IItemReader) {
              ...
              try {
                ...
                Files.write(
                    htmlViewer.tmpFile.toPath(),
                    preview.getBytes("UTF-8"),
  ...
  private String generatePreview(IItemReader item) {
    ...
    if (foreground != null) sb.append("color:").append(UiUtil.getHexRGB(foreground)).append(";");
    sb.append("\">\n");
    ...
    sb.append("<b>")
        .append(SimpleHTMLEncoder.htmlEncode(Messages.getString("AudioViewer.TranscriptionTitle")))
        .append("</b>");
