...
public class HexViewerPlus extends AbstractViewer implements KeyListener, MouseListener {
  ...
  private static String defaultSettingsPath =
      System.getProperty("user.home") + File.separator + ".iped" + File.separator + "iped.hvp";
  ...
  String descricaoExtensoes =
      Messages.getString("HexViewerPlus.HvpFileSettings") + " (*" + extensao + ")";
  ...
  private JMenuItem menuItemPesquisar,
      ...
      menuItemGoResult,
      menuItemGoNextHit,
      menuItemGoPreviousHit,
      menuItemSelecionarTudo;
  private JDialog dialogPesquisar,
      dialogSelecionar,
      dialogOpcoes,
  ...
  public HexViewerPlus(Window owner, HexSearcher hexSearcher) {
    ...
    charsetComboBox.addActionListener(
    ...
    codeArea.addCaretMovedListener(
        new CaretMovedListener() {
          @Override
          public void caretMoved(CaretPosition caretPosition, Section section) {
            if (formatoNumero.equals("%s"))
              posicao.setText(
                  String.format(formatoNumero, Long.toBinaryString(caretPosition.getDataPosition()))
                      .toUpperCase());
            else
              posicao.setText(
                  String.format(formatoNumero, caretPosition.getDataPosition()).toUpperCase());
          }
        });
            ...
            if (selection != null) {
              if (formatoNumero.equals("%s")) {
                selecao_inicial.setText(
                    String.format(
                            formatoNumero, Long.toBinaryString(codeArea.getSelection().getFirst()))
                        .toUpperCase());
                selecao_final.setText(
                    String.format(
                            formatoNumero, Long.toBinaryString(codeArea.getSelection().getLast()))
                        .toUpperCase());
              } else {
                selecao_inicial.setText(
                    String.format(formatoNumero, codeArea.getSelection().getFirst()).toUpperCase());
                selecao_final.setText(
                    String.format(formatoNumero, codeArea.getSelection().getLast()).toUpperCase());
              }
            } else {
              selecao_inicial.setText("");
              selecao_final.setText("");
    ...
    try {
      data =
          new ByteArraySeekData() {
            @Override
            void fireReadError() {
              try {
                this.setData(
                    new SeekableFileInputStream(
                        new SeekableInMemoryByteChannel("READ ERROR!".getBytes())));
              } catch (IOException e) {
                e.printStackTrace();
              }
    ...
    bottomPanelLeft.add(
        new JLabel(
            " " + Messages.getString("HexViewerPlus.to").toString().replaceAll(".", "  ") + "  "));
    ...
    if (defaultSettingsFile != null
        && defaultSettingsFile.exists()
        && defaultSettingsFile.isFile()
        && defaultSettingsFile.canRead()) {
      HVPSettings storedDefaultSettings = HVPSettings.loadObject(defaultSettingsPath);
      if (storedDefaultSettings != null) defaultSettings = storedDefaultSettings;
    }
    ...
    bottomPanel2.add(
        new JLabel("") {
          ...
          public void updateUI() {
            ...
            File defaultSettingsFile = new File(defaultSettingsPath);
            if (defaultSettingsFile != null && defaultSettingsFile.exists()) return;
  ...
  static class CustomTextField extends JTextField {
    ...
    public void updateUI() {
      ...
      if (c != null) setBackground(new Color(c.getRGB()));
    }
  }
  ...
  public void loadFile(final IStreamSource content, Set<String> highlightTerms) {
    ...
    if (highlightTerms == null) high = false;
    else {
      if (highlightTerms.size() == 0) high = false;
      else high = true;
    }
  ...
  public void scrollToNextHit(boolean forward) {
    ...
    if (hits.totalHits > 0) {
      ...
      resultSearch.setText(
          Messages.getString("HexViewerPlus.hit")
              + " "
              + (hits.currentHit + 1)
              + " "
              + Messages.getString("HexViewerPlus.of")
              + " "
              + hits.totalHits);
    }
  }
  ...
  public void createMenuAndDialogs() {
    ...
    menuItemPesquisar.setPreferredSize(
        new Dimension(150, menuItemPesquisar.getPreferredSize().height));
    ...
    this.codeArea.addMouseListener(
        new MouseAdapter() {
          public void mousePressed(MouseEvent event) {
  ...
  public void verifyEnabledItensPopupMenu() {
    if (hits.totalHits > 0) {
      ...
      if (hits.currentHit < hits.totalHits - 1) menuItemGoNextHit.setEnabled(true);
      else menuItemGoNextHit.setEnabled(false);
      if (hits.currentHit > 0) menuItemGoPreviousHit.setEnabled(true);
      else menuItemGoPreviousHit.setEnabled(false);
    } else {
  ...
  public void dialogOpcoes() {
    ...
    JLabel lblSelectionMirror =
        new JLabel(Messages.getString("HexViewerPlus.selectionCharactersMirror"));
    JLabel lblColorSelectionMirrorText = new JLabel(Messages.getString("HexViewerPlus.fontColor"));
    JLabel lblColorSelectionMirrorBackground =
        new JLabel(Messages.getString("HexViewerPlus.backGroundColor"));
    JLabel lblSelectionMain =
        new JLabel(Messages.getString("HexViewerPlus.selectionCharactersMain"));
    ...
    JLabel lblColorHeaderBackground =
        new JLabel(Messages.getString("HexViewerPlus.backGroundColor"));
    JLabel lblColorSelectionMainText = new JLabel(Messages.getString("HexViewerPlus.fontColor"));
    JLabel lblColorSelectionMainBackground =
        new JLabel(Messages.getString("HexViewerPlus.backGroundColor"));
    JLabel lblColorFoundMatch =
        new JLabel(Messages.getString("HexViewerPlus.searchHitsFoundMatch"));
    JLabel lblColorCurrentMatch =
        new JLabel(Messages.getString("HexViewerPlus.searchHitsCurrentMatch"));
    ...
    JLabel lblColorFoundMatchBackground =
        new JLabel(Messages.getString("HexViewerPlus.backGroundColor"));
    JLabel lblColorCurrentMatchBackground =
        new JLabel(Messages.getString("HexViewerPlus.backGroundColor"));
    ...
    hexCharactersCaseCheckBox =
        new JCheckBox(Messages.getString("HexViewerPlus.hexLowerCase"), false);
    ...
    showUnprintableCharactersCheckBox =
        new JCheckBox(Messages.getString("HexViewerPlus.showAllCharacters"), false);
    showLineNumberBackgroundCheckBox =
        new JCheckBox(Messages.getString("HexViewerPlus.showLineNumberBackground"), true);
    showPositionBarCheckBox =
        new JCheckBox(Messages.getString("HexViewerPlus.showPositionBar"), true);
    showSelectionBarCheckBox =
        new JCheckBox(Messages.getString("HexViewerPlus.showSelectionBar"), true);
    ...
    cursorBlinkSpinner =
        new JSpinner(new SpinnerNumberModel(codeArea.getCaret().getBlinkRate(), 50, 950, 50));
    ...
    btnColorSelectionMainBackground =
        new RoundButton("", codeArea.getSelectionColors().getBackgroundColor());
    btnColorSelectionMirrorText =
        new RoundButton("", codeArea.getMirrorSelectionColors().getTextColor());
    btnColorSelectionMirrorBackground =
        new RoundButton("", codeArea.getMirrorSelectionColors().getBackgroundColor());
    ...
    modeComboBox.setModel(
        new javax.swing.DefaultComboBoxModel<>(
            new String[] {"DUAL", "CODE_MATRIX", "TEXT_PREVIEW"}));
    ...
    codeTypeComboBox.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    positionCodeTypeComboBox.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            codeArea.setPositionCodeType(
                PositionCodeType.values()[positionCodeTypeComboBox.getSelectedIndex()]);
          }
        });

    backGroundComboBox.setModel(
        new javax.swing.DefaultComboBoxModel<>(
            new String[] {"NONE", "PLAIN", "STRIPPED", "GRIDDED"}));
    backGroundComboBox.setSelectedIndex(2);
    backGroundComboBox.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            codeArea.setBackgroundMode(
                BackgroundMode.values()[backGroundComboBox.getSelectedIndex()]);
          }
        });
    ...
    cursorComboBox.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            codeArea
                .getCaret()
                .setOverwriteCursorShape(CursorShape.values()[cursorComboBox.getSelectedIndex()]);
            codeArea
                .getCaret()
                .setInsertCursorShape(CursorShape.values()[cursorComboBox.getSelectedIndex()]);
          }
        });

    fontComboBox.setModel(
        new javax.swing.DefaultComboBoxModel<String>(fonts.toArray(new String[0])));
    ...
    cursorBlinkSpinner.addChangeListener(
        new ChangeListener() {
          public void stateChanged(ChangeEvent e) {
    ...
    lineSizeSpinner.addChangeListener(
        new ChangeListener() {
          public void stateChanged(ChangeEvent e) {
    ...
    formatoNumeroComboBox.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
              ...
              case 1:
                {
                  ...
                  if (!posicao.getText().isEmpty())
                    posicao.setText(
                        String.format(formatoNumero, Long.parseLong(posicao.getText(), ultimaBase))
                            .toUpperCase());
                  if (!selecao_inicial.getText().isEmpty()) {
                    selecao_inicial.setText(
                        String.format(
                    ...
                    selecao_final.setText(
                        String.format(
                                formatoNumero, Long.parseLong(selecao_final.getText(), ultimaBase))
                            .toUpperCase());
                  }
                  ultimaBase = 8;
                  break;
    ...
    wrapLineModeCheckBox.addItemListener(
    ...
    showUnprintableCharactersCheckBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    showLineNumberBackgroundCheckBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    hexCharactersCaseCheckBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
            ...
            else codeArea.setHexCharactersCase(org.exbin.deltahex.HexCharactersCase.LOWER);
          }
        });

    showHeaderCheckBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    showLineNumbersCheckBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    showPositionBarCheckBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    showSelectionBarCheckBox.addItemListener(
        new java.awt.event.ItemListener() {
          public void itemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    btnColorFontMain.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, codeArea.getMainColors().getTextColor());
            if (c != null) {
    ...
    btnColorFontAlt.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, codeArea.getAlternateColors().getTextColor());
            if (c != null) {
    ...
    btnColorCursor.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(dialogOpcoes, selectColorText, codeArea.getCursorColor());
            if (c != null) {
    ...
    btnColorBackgroundMain.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, codeArea.getMainColors().getBackgroundColor());
            if (c != null) {
              ColorsGroup cg = codeArea.getMainColors();
    ...
    btnColorBackgroundAlt.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
    ...
    btnColorHeaderBackground.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(dialogOpcoes, selectColorText, codeArea.getBackground());
            if (c != null) {
    ...
    btnColorHeaderText.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(dialogOpcoes, selectColorText, codeArea.getForeground());
            if (c != null) {
    ...
    btnColorSelectionMainBackground.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
    ...
    btnColorSelectionMainText.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, codeArea.getSelectionColors().getTextColor());
            if (c != null) {
              ColorsGroup cg = codeArea.getSelectionColors();
              cg.setTextColor(c);
              cg.setUnprintablesColor(c);
    ...
    btnColorSelectionMirrorBackground.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
    ...
    btnColorSelectionMirrorText.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
    ...
    btnColorFoundMatchText.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, painter.getFoundMatchesTextColor());
            if (c != null) {
    ...
    btnColorFoundMatchBackground.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, painter.getFoundMatchesBackgroundColor());
            if (c != null) {
    ...
    btnColorCurrentMatchText.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, painter.getCurrentMatchTextColor());
            if (c != null) {
    ...
    btnColorCurrentMatchBackground.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color c =
                JColorChooser.showDialog(
                    dialogOpcoes, selectColorText, painter.getCurrentMatchBackgroundColor());
            if (c != null) {
    ...
    buttonLoadDefault.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            loadSettings(defaultSettings);
            codeArea.repaint();
    ...
    buttonSaveDefault.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
    ...
    buttonLoad.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            String openPath =
                ""; // Initialize openPath with "defaultSettingsPath' to open IPED root path
            ...
            if (retDialog == JFileChooser.APPROVE_OPTION) {
              ...
              if (objHVP != null) {
                ...
                JOptionPane.showMessageDialog(
                    dialogOpcoes,
                    Messages.getString("HexViewerPlus.failOpenFile"),
                    appName,
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            if (retDialog == JFileChooser.APPROVE_OPTION) {
              ...
              if (verificarSalvarArquivo(caminho)) return;
              HVPSettings objHVP = new HVPSettings();
              saveSettings(objHVP);
              if (!HVPSettings.saveObject(caminho, objHVP)) {
                JOptionPane.showMessageDialog(
                    dialogOpcoes,
                    Messages.getString("HexViewerPlus.failSaveFile"),
                    appName,
                    JOptionPane.ERROR_MESSAGE);
              }
              objHVP = null;
  ...
  public static String getAndVerifyFontName(String name, List<String> fonts) {
    ...
    if (fonts != null) {
      ...
      if (index != -1) return fonts.get(index);
      else return Font.MONOSPACED;
    } else {
  ...
  public boolean verificarSalvarArquivo(String arquivo) {
    ...
    Object[] options = {
      Messages.getString("HexViewerPlus.yes"), Messages.getString("HexViewerPlus.no")
    };
    ...
    if (fileName != null && fileName.exists()) {
      ...
      int n =
          JOptionPane.showOptionDialog(
              dialogOpcoes,
              "'" + arquivo + "' " + Messages.getString("HexViewerPlus.overWriteFile"),
              appName,
              ...
              options,
              options[1]);
      if (n == JOptionPane.NO_OPTION) return true;
    }
  ...
  public void saveSettings(HVPSettings values) {
    ...
    values.ColorSelectionMirrorBackground =
        codeArea.getMirrorSelectionColors().getBackgroundColor();
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            if (!jtfEnd1.isValidNumber()) {
              JOptionPane.showMessageDialog(
                  dialogSelecionar,
                  Messages.getString("HexViewerPlus.invalidStartPosition"),
                  appName,
                  JOptionPane.ERROR_MESSAGE);
              jtfEnd1.requestFocus();
              return;
            ...
            if (!jtfEnd2.isValidNumber()) {
              ...
              if (jrbTam.isSelected())
                JOptionPane.showMessageDialog(
                    dialogSelecionar,
                    Messages.getString("HexViewerPlus.invalidSize"),
                    appName,
                    JOptionPane.ERROR_MESSAGE);
              else
                JOptionPane.showMessageDialog(
                    dialogSelecionar,
                    Messages.getString("HexViewerPlus.invalidEndPosition"),
                    appName,
                    JOptionPane.ERROR_MESSAGE);
              return;
            }
            ...
            if (jrbTam.isSelected()) position2 += position1;

            long size = codeArea.getDataSize();

            if (position1 > size) position1 = size;

            if (position2 > size) position2 = size;
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            if (jtfTexto.isValidNumber()) {
              try {
                ...
                JOptionPane.showMessageDialog(
                    dialogIrParaResultado,
                    Messages.getString("HexViewerPlus.invalidHit"),
                    appName,
                    JOptionPane.ERROR_MESSAGE);
                return;
              }
  ...
  public void dialogIrParaEndereco() {
    ...
    dialogIrParaEndereco.setTitle(
        Messages.getString("HexViewerPlus.goToPosition") + " - " + appName);
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            if (!jtfTexto.isValidNumber()) {
              JOptionPane.showMessageDialog(
                  dialogIrParaEndereco,
                  Messages.getString("HexViewerPlus.invalidPosition"),
                  appName,
                  JOptionPane.ERROR_MESSAGE);
              return;
            }
            ...
            if (jrbCursor.isSelected()) position += codeArea.getCaretPosition().getDataPosition();
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            if (jrbTexto.isSelected()) {
              if (jtfTextoHex.getText().toString().trim().isEmpty()) {
                JOptionPane.showMessageDialog(
                    dialogPesquisar,
                    Messages.getString("HexViewerPlus.invalidSearchText"),
                    appName,
                    JOptionPane.ERROR_MESSAGE);
                jtfTextoHex.requestFocus();
                return;
              ...
              if (!jtfTextoHex.isValidHexString()) {
                JOptionPane.showMessageDialog(
                    dialogPesquisar,
                    Messages.getString("HexViewerPlus.invalidHexadecimalText"),
                    appName,
                    JOptionPane.ERROR_MESSAGE);
                jtfTextoHex.requestFocus();
                return;
            ...
            if (jrbCompleto.isSelected()) {
              ...
              if (!jtfMaxHits.isValidNumber()) {
                JOptionPane.showMessageDialog(
                    dialogPesquisar,
                    Messages.getString("HexViewerPlus.invalidMax"),
                    appName,
                    JOptionPane.ERROR_MESSAGE);
                return;
              }
              try {
                ...
                JOptionPane.showMessageDialog(
                    dialogPesquisar,
                    Messages.getString("HexViewerPlus.invalidMaxLessThen") + max_terms,
                    appName,
                    JOptionPane.ERROR_MESSAGE);
                return;
              }
            ...
            if (jrbTexto.isSelected()) {
              if (charSetString != null
                  && !charSetString.isEmpty()
                  && Charset.isSupported(charSetString)) {
                charsetParam = Charset.forName(charSetString);
              } else {
                JOptionPane.showMessageDialog(
                    dialogPesquisar,
                    Messages.getString("HexViewerPlus.charset")
                        + " \""
                        + charSetString
                        + "\" "
            ...
            if (contentAux != null) {
              try {
                ...
                dialogPesquisar.setVisible(false);
                hexSearcher.doSearch(
                    codeArea,
                    painter,
                    hits,
                    contentAux.getSeekableInputStream(),
                    charsetParam,
                    palavras,
                    off,
                    jrbTexto.isSelected(),
...
class HVPComboField extends JComboBox<String> {
        ...
        new KeyAdapter() {
          ...
          public void keyTyped(KeyEvent ev) {
            ...
            if (textAllowed) {
              ...
              int k = ev.getKeyCode();
              boolean copy =
                  ((ev.getKeyCode() == KeyEvent.VK_C)
                      && ((ev.getModifiersEx() & KeyEvent.CTRL_DOWN_MASK) != 0));
              boolean paste =
                  ((ev.getKeyCode() == KeyEvent.VK_V)
                      && ((ev.getModifiersEx() & KeyEvent.CTRL_DOWN_MASK) != 0));
  ...
  public boolean isValidHexString() {
    ...
    for (int i = 0; i < charArray.length; i++) {
      if (!isDigitBase(charArray[i])) return false;
    }
  ...
  private boolean isDigitBase(char c) {
    ...
    if (Character.isLetterOrDigit(c)) {
      ...
      if (index >= 0 && index < this.base) return true;
    }
    return false;
  }
}
...
class ImageFileView extends FileView {
  ...
  public static final String hvp = "hvp";
...
class RoundButton extends JButton {
  ...
  protected void paintComponent(Graphics g) {
    ...
    if (this.hasFocus()) {
      if (buttonFocusColor == null) buttonFocusColor = new Color(115, 164, 209);
    ...
    if (getModel().isArmed()) {
      ...
      else g.setColor(Blend(getBackground(), Color.WHITE, 0.65f));
    } else {
...
class CursorComponent extends JComponent {
  ...
  protected void drawCenteredChar(
      Graphics g,
      char[] drawnChars,
      int charOffset,
      int charWidthSpace,
  ...
  protected void drawShiftedChar(
      Graphics g,
      char[] drawnChars,
      int charOffset,
      int charWidthSpace,
  ...
  public void paint(Graphics g) {
    ...
    if (cursorVisible && cursorPoint != null) {
      ...
      CodeAreaCaret.CursorShape cursorShape =
          codeArea.getEditationMode() == EditationMode.INSERT
      ...
      switch (cursorShape) {
        ...
        case HALF_TOP:
          {
            paintCursorRect(
                g, cursorPoint.x, cursorPoint.y, charWidth, cursorThickness, renderingMode);
            break;
          }
        case LINE_BOTTOM:
        case DOUBLE_BOTTOM:
        ...
        case HALF_BOTTOM:
          {
            paintCursorRect(
                g,
                cursorPoint.x,
                cursorPoint.y + lineHeight - cursorThickness,
                charWidth,
                cursorThickness,
                renderingMode);
            break;
        ...
        case HALF_LEFT:
          {
            paintCursorRect(
                g, cursorPoint.x, cursorPoint.y, cursorThickness, lineHeight, renderingMode);
            break;
          }
        case LINE_RIGHT:
        case DOUBLE_RIGHT:
        ...
        case HALF_RIGHT:
          {
            paintCursorRect(
                g,
                cursorPoint.x + charWidth - cursorThickness,
                cursorPoint.y,
                cursorThickness,
                lineHeight,
                renderingMode);
        ...
        case CORNERS:
          {
            ...
            if (cursorShape == CodeAreaCaret.CursorShape.CORNERS) {
              ...
              g.drawLine(
                  cursorPoint.x + charWidth - quarterWidth,
                  cursorPoint.y,
                  cursorPoint.x + charWidth,
                  cursorPoint.y);

              g.drawLine(
                  cursorPoint.x, cursorPoint.y + 1, cursorPoint.x, cursorPoint.y + quarterLine);
              g.drawLine(
                  cursorPoint.x + charWidth,
                  cursorPoint.y + 1,
                  cursorPoint.x + charWidth,
            ...
            g.drawLine(
                cursorPoint.x,
                cursorPoint.y + lineHeight - quarterLine - 1,
                cursorPoint.x,
      ...
      case NEGATIVE:
        {
          ...
          int scrolledX =
              x
                  + scrollPosition.getScrollCharPosition() * charWidth
                  + scrollPosition.getScrollCharOffset();
          int posY =
              codeRect.y
                  + (line + 1) * lineHeight
                  - codeArea.getSubFontSpace()
          ...
          if (codeArea.getViewMode() != ViewMode.CODE_MATRIX && scrolledX >= previewX) {
            ...
            long dataPosition =
                (line + scrollPosition.getScrollLinePosition()) * codeArea.getBytesPerLine()
                    + charPos
                    - scrollPosition.getLineByteShift();
            ...
            CodeAreaUtils.byteToCharsCode(
                dataByte, codeArea.getCodeType(), lineChars, 0, codeArea.getHexCharactersCase());
            int posX =
                codeRect.x
                    + codeCharPos * charWidth
                    - scrollPosition.getScrollCharPosition() * charWidth
                    - scrollPosition.getScrollCharOffset();
            ...
            if (codeArea.getCharRenderingMode() == CodeArea.CharRenderingMode.LINE_AT_ONCE) {
              ...
              drawCenteredChar(
                  g, lineChars, charsOffset, charWidth, posX + (charsOffset * charWidth), posY);
            }
          }
          g.setClip(clip);
          break;
