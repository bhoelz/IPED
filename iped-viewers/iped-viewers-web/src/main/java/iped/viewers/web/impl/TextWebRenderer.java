...
/**
 * Serves plain-text items as UTF-8 text. Highlighting is done client-side. This renderer acts as a
 * last-resort fallback for any text/* MIME type.
 */
