...
/**
 * Serves PDFs as raw bytes (browser renders natively) and optionally renders individual pages to
 * PNG using PDFBox for thumbnail/search support.
 */
@Slf4j
public class PdfWebRenderer implements WebRenderer {
  ...
  private void renderPageAsImage(RenderRequest request, OutputStream out) throws IOException {
    ...
    try (PDDocument doc = Loader.loadPDF(pdfBytes)) {
      ...
      log.warn(
          "Failed to render PDF page {} for item {}: {}",
          targetPage,
