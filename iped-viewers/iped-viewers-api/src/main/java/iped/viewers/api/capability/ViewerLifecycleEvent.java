 ...
 *
 * <p>Web viewers dispatch these as typed CustomEvents (Angular island contract). Native viewers
 * implement {@link IViewerLifecycleListener} if lifecycle callbacks are needed in the Swing or
 * companion-app path.
 *
