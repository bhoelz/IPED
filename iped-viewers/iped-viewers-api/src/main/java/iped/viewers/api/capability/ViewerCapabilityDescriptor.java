...
/**
 * Immutable description of a viewer's capabilities, rendering target, and web-portability
 * classification.
 *
 * <p>Returned by {@link IViewerCapability#getCapabilityDescriptor()} so the framework can route
 * items to the right viewer without instantiating one.
 *
 * <h3>Usage</h3>
 *
 * <pre>
...
public final class ViewerCapabilityDescriptor {
  ...
  public ViewerClassification getClassification() {
  ...
  public boolean isHitsSupported() {
    return hitsSupported;
  }
  ...
  public static final class Builder {
    ...
    public Builder mimeTypes(String... types) {
      this.supportedMimeTypes = Set.of(types);
      return this;
    }

    public Builder mimeTypes(Set<String> types) {
      this.supportedMimeTypes = Set.copyOf(types);
      return this;
    }

    public Builder renderTarget(RenderTarget t) {
      this.primaryRenderTarget = t;
      return this;
    }

    public Builder classification(ViewerClassification c) {
      this.classification = c;
      return this;
    }

    public Builder classificationNote(String n) {
      this.classificationNote = n;
      return this;
    }

    public Builder hitsSupported(boolean v) {
      this.hitsSupported = v;
      return this;
    }

    public Builder searchSupported(boolean v) {
      this.searchSupported = v;
      return this;
    }

    public Builder toolbarSupported(boolean v) {
      this.toolbarSupported = v;
      return this;
    }
  ...
  public String toString() {
    return "ViewerCapabilityDescriptor{name="
        + viewerName
        + ", target="
        + primaryRenderTarget
        + ", class="
