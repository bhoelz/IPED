...
- Task script loading and lifecycle:
  - `iped-engine-parent/iped-engine/src/main/java/iped/engine/config/TaskInstallerConfig.java`
  - `iped-tasks/iped-tasks-forensics/src/main/java/iped/engine/task/ScriptTask.java`
  - `iped-tasks/iped-tasks-forensics/src/main/java/iped/engine/task/PythonTask.java`
...
- Regex validator scripting:
  - `iped-tasks/iped-tasks-forensics/src/main/java/iped/engine/task/regex/validator/ScriptValidatorService.java`
- Carver scripting:
  - `iped-tasks/iped-tasks-carving/src/main/java/iped/engine/task/carver/XMLCarverConfiguration.java`
  - `iped-carvers/iped-carvers-impl/src/main/java/iped/carvers/standard/JSCarver.java`

> Paths above were corrected 2026-06-21: `ScriptTask`, `PythonTask`, `ScriptValidatorService`,
> and `XMLCarverConfiguration` moved out of `iped-engine` into `iped-tasks-forensics`/
> `iped-tasks-carving` during the engine module split; the original version of this doc
> still referenced their pre-split location.
