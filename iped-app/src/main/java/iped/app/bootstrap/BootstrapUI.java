 ...
 * <ul>
 *   <li>Splash screen startup in {@link #configLoaded()}</li>
 *   <li>Child-process PID registration for splash-screen progress in
 *       {@link #onChildProcessStarted(Process)}</li>
 *   <li>LibreOffice UNO JAR discovery in {@link #extendClasspath(Main, String)}</li>
 * </ul>
 *
 * <p>All AWT/Swing/LibreOffice imports are confined to this class so that the
 * headless {@link Bootstrap} remains loadable in a server JVM without a display.
 */
