...
public class FiltersPanel extends JPanel
    implements ClearFilterListener,
        IQueryFilterer // internal combinedfilterer wrapper to reflect on panel color
{
  ...
  public void install(FilterManager filterManager) {
    ...
    CheckBoxTreeCellRenderer treeCellRenderer =
        new CheckBoxTreeCellRenderer(
            filtersTree,
    ...
    filtersTree.addMouseMotionListener(
    ...
    structuredFiltererTree.setCellRenderer(
    ...
    ckStructuredFilterer.setToolTipText(
        Messages.get(combinedFilterer.getClass().getName() + Messages.TOOLTIP_NAME_SUFFIX));
    ckStructuredFilterer.addItemListener(
        new ItemListener() {
          @Override
    ...
    structuredFiltererTree.addMouseListener(
        new MouseAdapter() {
          public void showPopupMenu(MouseEvent e) {
            Object o =
                structuredFiltererTree
