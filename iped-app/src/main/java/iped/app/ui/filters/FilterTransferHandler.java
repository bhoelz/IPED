...
public class FilterTransferHandler extends TransferHandler {
  ...
  public static final DataFlavor filterFlavor = new DataFlavor(IFilter.class, "iped.IFilter");
  public static final DataFlavor filterNodeFlavor =
      new DataFlavor(FilterNode.class, "iped.FilterNode");
  public static final DataFlavor operandNodeFlavor =
      new DataFlavor(OperandNode.class, "iped.OperandNode");
  public static final DataFlavor parentOperandNodeFlavor =
      new DataFlavor(OperandNode.class, "iped.parentOperandNode");
  ...
  public boolean canImport(JComponent comp, DataFlavor[] transferFlavors) {
    for (int i = 0; i < transferFlavors.length; i++) {
      if (transferFlavors[i].equals(filterFlavor)
          || transferFlavors[i].equals(filterNodeFlavor)
  ...
  protected Transferable createTransferable(JComponent c) {
    ...
    if (o != null && !(o instanceof IFilterer)) {
      Transferable result =
          new Transferable() {
            private DataFlavor[] filterFlavors = {
              filterFlavor, filterNodeFlavor, operandNodeFlavor
            };
            ...
            public Object getTransferData(DataFlavor flavor)
              ...
              if (flavor
                  ...
                  .equals(operandNodeFlavor.getHumanPresentableName())) {
              ...
              if (flavor
                  .getHumanPresentableName()
                  .equals(parentOperandNodeFlavor.getHumanPresentableName())) {
            ...
            try {
              ...
              if (e.getCause() instanceof QueryNodeException) {
                JOptionPane.showMessageDialog(
                    tree.getRootPane(), Messages.get("FiltersPanel.addQueryFilterError"));
                return false;
              }
            }
          }
