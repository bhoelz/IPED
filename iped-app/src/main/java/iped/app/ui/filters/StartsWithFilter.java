...
/**
 * A ValueFilter that checks in which docs the specified field starts with the provided string
 * value.
 *
  ...
  public StartsWithFilter(String field, String value) {
    ...
    if (isNumeric) {
      throw new UnsupportedOperationException(
          StartsWithFilter.class.getSimpleName() + " cannot be used with numeric values");
    }
  }
