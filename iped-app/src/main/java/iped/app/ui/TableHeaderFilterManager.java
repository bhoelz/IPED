...
public class TableHeaderFilterManager implements IResultSetFilterer, IQueryFilterer {
  ...
  public static TableHeaderFilterManager get() {
    return singleton;
  }
  ...
  public boolean isFieldFiltered(String field) {
    field = escape(field);
    return definedFilters.get(field) != null
        || selectedValues.get(field) != null
        || otherFilters.get(field) != null;
  }
  ...
  public boolean getContainsEmptyFilter(String field) {
    ...
    return filter != null
        && (filter.equals("-" + field + ":?*") || filter.equals("-" + field + ":[* TO *]"));
  }
