...
public class AIFiltersTreeListener
    implements TreeSelectionListener, TreeExpansionListener, IQueryFilterer {
  ...
  public void valueChanged(TreeSelectionEvent evt) {
    ...
    if (root == null) root = new TreePath(App.get().aiFiltersTree.getModel().getRoot());
