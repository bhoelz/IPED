...
public class ThemeManager {
  ...
  public synchronized void setLookAndFeel() throws Exception {
    ...
    if (nimbusFound) {
      ...
      if (selTheme == null) selTheme = themes.get(0);
      setTheme(selTheme);
    } else {
  ...
  public synchronized void setTheme(Theme newTheme) {
    if (newTheme == null || newTheme.equals(currentTheme)) return;
    if (currentTheme != null) currentTheme.clean();
