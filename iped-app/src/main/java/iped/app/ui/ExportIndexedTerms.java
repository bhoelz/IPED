...
public class ExportIndexedTerms extends CancelableWorker<Boolean, Integer>
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (progressMonitor.isCanceled()) {
      ...
      progressMonitor.setNote(
          Messages.getString("ExportIndexedTerms.Exported")
              + progress //$NON-NLS-1$
              + Messages.getString(
                  "ExportIndexedTerms.ofWords")); // + " de " + total); //$NON-NLS-1$
