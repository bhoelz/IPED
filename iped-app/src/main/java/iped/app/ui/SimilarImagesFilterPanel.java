...
public class SimilarImagesFilterPanel extends JPanel implements ClearFilterListener {
  ...
  protected String buildDefaultToolTip(
      String tooltipTitle, String tooltipDescInternal, String tooltipDescExternal) {
    return "<HTML>"
        + tooltipTitle
        + "<br>"
        + (isRefExternal ? tooltipDescExternal : tooltipDescInternal)
        + ": <b>"
        + refName
        + "</b></HTML>";
  }
