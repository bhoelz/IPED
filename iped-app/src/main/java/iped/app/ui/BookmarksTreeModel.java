...
public class BookmarksTreeModel implements TreeModel {
  ...
  public static final String ROOT_NAME =
      Messages.getString("BookmarksTreeModel.RootName"); // $NON-NLS-1$
  public static final String NO_BOOKMARKS_NAME =
      Messages.getString("BookmarksTreeModel.NoBookmarks"); // $NON-NLS-1$
