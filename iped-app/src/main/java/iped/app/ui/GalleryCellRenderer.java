...
public class GalleryCellRenderer implements TableCellRenderer {
  ...
  public void updateUI() {
    ...
    if (borderColor == null) borderColor = new Color(200, 200, 202);
...
class GalleryThumbLabel extends JLabel {
  ...
  private static final String unsupportedIconText =
      "<html><center>" + Messages.getString("UnsupportedIcon.Unavailable") + "</center></html>";
  ...
  public void updateUI() {
    ...
    if (warningColor == null) warningColor = Color.red;
  }
