...
public class UiIconSize {
  private static final File file =
      new File(System.getProperty("user.home") + "/.iped", "UiIconSize.txt");
  private static final String[] keys =
      new String[] {"CatIconSize", "GalleryIconSize", "TableIconSize"};
  private static final String[] comments =
      new String[] {"for categories", "in the gallery", "in tables and other UI elements"};
  private static final String lastSavedKey = "LastSaved";
  private static final int[] defaultSizes =
      new int[] {
        IconManager.defaultCategorySize, IconManager.defaultGallerySize, IconManager.defaultSize
      };
  ...
  public static void saveUserSetting(int[] sizes) {
    try {
      ...
      Files.write(
          file.toPath(), l, StandardOpenOption.TRUNCATE_EXISTING, StandardOpenOption.CREATE);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
