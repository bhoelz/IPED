...
public class HighlightWorker extends BitSetHighlightWorker {
  ...
  public HighlightWorker(
      ...
      Date start,
      Date end,
      boolean clearPreviousHighlighted) {
  ...
  public void highlightItemsOnInterval(
      Date start, Date end, boolean select, boolean clearPreviousSelection) {
    Date d1 = new Date();
    ...
    for (int i = entityCount - 1; i >= 0; i--) {
      ...
      if (entity instanceof XYItemEntity) {
        ...
        long entStartTimeStamp =
            ds.getStartX(xyItemEntity.getSeriesIndex(), xyItemEntity.getItem()).longValue();
