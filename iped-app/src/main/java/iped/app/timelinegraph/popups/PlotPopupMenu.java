...
public class PlotPopupMenu extends JPopupMenu implements ActionListener {
  ...
  public PlotPopupMenu(IpedChartPanel ipedChartPanel, IMultiSearchResultProvider resultsProvider) {
    ...
    openIntervalsDialogMenu =
        new JMenuItem(Messages.getString("TimeLineGraph.openIntervalsDialogMenu"));
  ...
  public void setDate(Date date) {
    ...
    filterBeforeMenu.setText(
        Messages.getString("TimeLineGraph.filterBefore") + " " + sdf.format(date));
    filterAfterMenu.setText(
        Messages.getString("TimeLineGraph.filterAfter") + " " + sdf.format(date));
    selectBeforeMenu.setText(
        Messages.getString("TimeLineGraph.selectBefore") + " " + sdf.format(date));
    selectAfterMenu.setText(
        Messages.getString("TimeLineGraph.selectAfter") + " " + sdf.format(date));
  }
}
