...
public class ChartPanelPopupMenu extends JPopupMenu implements ActionListener {
  ...
  public ChartPanelPopupMenu(IpedChartPanel ipedChartPanel) {
    ...
    applyFiltersMenu =
        new JCheckBoxMenuItem(Messages.getString("TimeLineGraph.applyDefinedFilters"));
    ...
    syncSelectionMenu =
        new JCheckBoxMenuItem(Messages.getString("TimeLineGraph.syncTableSelectionInChartView"));
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getSource() == syncSelectionMenu) {
      ipedChartPanel
          .getIpedChartsPanel()
          .setSyncViewWithTableSelection(syncSelectionMenu.isSelected());
