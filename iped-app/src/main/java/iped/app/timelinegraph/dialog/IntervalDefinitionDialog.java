...
public class IntervalDefinitionDialog {
  ...
  FocusAdapter dateFieldFocusAdapter =
      new FocusAdapter() {
        @Override
  ...
  FocusAdapter timeFieldExitFocusAdapter =
      new FocusAdapter() {
        public void focusLost(FocusEvent event) {
  ...
  ActionListener timeFieldExitActionListener =
      new ActionListener() {
  ...
  KeyListener timeFieldKeyListener =
      new KeyListener() {
        @Override
          ...
          d[0] =
              ipedChartPanel
                  ...
                  .getDateOnConfiguredTimePeriod(
                      ipedChartPanel.getIpedChartsPanel().getTimePeriodClass(), cal.getTime())
                  .getStart();
          d[1] =
              new Date(
                  d[0].getTime()
                      + (long) ipedChartPanel.getIpedChartsPanel().getTimePeriodLength());
  ...
  static HashMap<Class<? extends TimePeriod>, String> dateFormaters =
      new HashMap<Class<? extends TimePeriod>, String>();
  ...
  public IntervalDefinitionDialog(IpedChartPanel ipedChartPanel) {
    ...
    sdfHour =
        new SimpleDateFormat(Messages.getString("IntervalDefinitionDialog.hourFormat", "HH:mm:ss"));
    sdfDate =
        new SimpleDateFormat(
            Messages.getString("IntervalDefinitionDialog.dateFormat", "dd/MM/yyyy"));
    sdfHour.setLenient(false);

    exitAction =
        new AbstractAction(Messages.getString("IntervalDefinitionDialog.Exit")) {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    for (Component comp : footer.getComponents()) ((JComponent) comp).setAlignmentX(0);
