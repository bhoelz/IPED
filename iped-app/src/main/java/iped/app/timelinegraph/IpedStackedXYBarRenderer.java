...
public class IpedStackedXYBarRenderer extends StackedXYBarRenderer {
  ...
  HashMap<Dataset, HashSet<Integer>> invisibleSeriesInLegend =
      new HashMap<Dataset, HashSet<Integer>>();
   ...
   */
  /**
   * Returns a boolean that indicates whether or not the specified series should be drawn. In fact
   * this method should be named lookupSeriesVisible() to be consistent with the other series
  ...
  public double getMargin() {
    double length =
        ipedChartsPanel
            .getDomainAxis()
            .lengthToJava2D(
                ipedChartsPanel.getTimePeriodLength(),
