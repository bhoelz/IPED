...
public class ExpandConfigurationDialog extends JDialog implements MouseListener {
  ...
  private class ExpandConfigurationWorker extends SwingWorker<Void, Void>
      implements ConnectionQueryListener {
  ...
  private static class ExpandConfigurationTableModel extends AbstractTableModel {
    ...
    private String[] headers =
        new String[] {
          Messages.getString("GraphAnalysis.Type"), Messages.getString("GraphAnalysis.Quantity")
        };
