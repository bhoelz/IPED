...
public class GraphSidePanel extends JPanel {
  ...
  private void init(GraphPane graphPane) {
    ...
    JSplitPane splitPane =
        new JSplitPane(JSplitPane.VERTICAL_SPLIT, containerPanel, graphPreviewPane);
  ...
  private static class NodePropertiesDataModel extends AbstractTableModel {
    ...
    private String[] headers =
        new String[] {
          Messages.getString("GraphAnalysis.Property"), Messages.getString("GraphAnalysis.Value")
        };
