 ...
 * new {@link org.apache.iped.parsers.sqlite.SQLite3DBParser}.
 *
 * <p>Given potential conflicts of native libraries in web servers, users will need to add
 * org.xerial's sqlite-jdbc jar to the class path for this parser to work. For development and
 * testing, this jar is specified in tika-parsers' pom.xml, but it is currently set to "provided."
 *
 * <p>Note that this family of jdbc parsers is designed to treat each CLOB and each BLOB as embedded
 * documents.
 */
public class SQLite3Parser extends AbstractParser {
   ...
   *
   * <p>If not, this class will return an EMPTY_SET for getSupportedTypes()
   */
  ...
  public static Properties getConnectionProperties() {
    ...
    prop.setProperty(
        SQLiteConfig.Pragma.JOURNAL_MODE.pragmaName, SQLiteConfig.JournalMode.DELETE.name());
