  ...
  private static int getISODataOffset(File file) {
    ...
    try {
      ...
      if (matchMagic(magicISO9660, header, 32769)
          ...
          || matchMagic(magicUDF, header, 34817)) return 0;
      ...
      if (matchMagic(magicISO9660, header, 37649)
          ...
          || matchMagic(magicUDF, header, 40001)) return 16;
      ...
      if (matchMagic(magicISO9660, header, 37657)
          ...
          || matchMagic(magicUDF, header, 40009)) return 24;
  ...
  public static File convertTo2048SectorISO(File iso, TemporaryResources tmp) {
    ...
    try {
      ...
      while (read != -1) {
        ...
        if (dataOffset == 16) {
          if (data[15] == 0x01) fos.write(data, dataOffset, 2048);
          else fos.write(data, dataOffset, 2336);
        }
        if (dataOffset == 24) {
          if (data[23] != 0x01) fos.write(data, dataOffset, 2048);
          else fos.write(data, dataOffset, 2324);
        }
      }
