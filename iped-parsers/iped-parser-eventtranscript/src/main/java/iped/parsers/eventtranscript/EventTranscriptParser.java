 ...
 * <p>Data collected:
 *
 * <p>Browser History through HJ_HistoryAddUrl and HJ_HistoryAddUrlEx events
 *
 * <p>Inventory Applications (Installed apps state)
...
public class EventTranscriptParser extends SQLite3DBParser {
  ...
  public static final MediaType EVENT_TRANSCRIPT_HIST =
      MediaType.application("x-event-transcript-history");
  public static final MediaType EVENT_TRANSCRIPT_HIST_REG =
      MediaType.application("x-event-transcript-history-registry");

  public static final MediaType EVENT_TRANSCRIPT_INVENTORY_APP =
      MediaType.application("x-event-transcript-inventory-app");
  public static final MediaType EVENT_TRANSCRIPT_INVENTORY_APP_REG =
      MediaType.application("x-event-transcript-inventory-app-registry");

  public static final MediaType EVENT_TRANSCRIPT_APP_INTERACT =
      MediaType.application("x-event-transcript-app-interactivity");
  public static final MediaType EVENT_TRANSCRIPT_APP_INTERACT_REG =
      MediaType.application("x-event-transcript-app-interactivity-registry");

  public static final MediaType EVENT_TRANSCRIPT_DEVICES =
      MediaType.application("x-event-transcript-devices");
  public static final MediaType EVENT_TRANSCRIPT_DEVICES_REG =
      MediaType.application("x-event-transcript-devices-registry");

  public static final MediaType EVENT_TRANSCRIPT_CENSUS =
      MediaType.application("x-event-transcript-census");
  public static final MediaType EVENT_TRANSCRIPT_CENSUS_REG =
      MediaType.application("x-event-transcript-census-registry");

  public static final MediaType EVENT_TRANSCRIPT_NETWORKING =
      MediaType.application("x-event-transcript-networking");
  public static final MediaType EVENT_TRANSCRIPT_NETWORKING_REG =
      MediaType.application("x-event-transcript-networking-registry");
  ...
  private static final String[] HISTORY_COLUMN_NAMES =
      new String[] {
        "Page Titles", "Visit Date (UTC)", "Local Time", "Timezone", "Referrer URL", "URL", "App"
      };
  private static final String[] INVENTORY_APPS_COLUMN_NAMES =
      new String[] {
        "Name",
        "Timestamp (UTC)",
        "Local Time",
  ...
  private static final String[] APP_INTERACT_COLUMN_NAMES =
      new String[] {
        "App",
        "Timestamp (UTC)",
        "Local Time",
  ...
  private static final String[] DEVICES_COLUMN_NAMES =
      new String[] {
        "Model",
        "Timestamp (UTC)",
        "Local Time",
  ...
  private static final String[] CENSUS_COLUMN_NAMES =
      new String[] {"Timestamp (UTC)", "Local Time", "Timezone", "Event", "State \\ Settings"};
  private static final String[] NETWORK_COLUMN_NAMES =
      new String[] {
        "Timestamp (UTC)",
        "Local Time",
        "Timezone",
  ...
  public void parse(
    ...
    try (Connection connection = getConnection(tis, metadata, context)) {
      ...
      try (BufferedOutputStream tmpHistoryFile =
          new BufferedOutputStream(new FileOutputStream(browserHistoryFile))) {
        ...
        try (HistoryIterator historyEntriesIterator =
            new HistoryIterator(connection, DBQueries.HISTORY)) {
          XHTMLContentHandler xHandler =
              emitHeader(historyHandler, metadataHistory, title, HISTORY_COLUMN_NAMES);
          ...
          while (historyEntriesIterator.hasNext()) {
            ...
            String[] rowValues =
                new String[] {
                  String.join("; ", historyEntry.getPageTitles()),
                  historyEntry.getTimestampStr(),
                  historyEntry.getLocalTime(),
                  historyEntry.getTimezone(),
                  historyEntry.getReferUrl(),
                  historyEntry.getUrl(),
                  historyEntry.getAppName()
                };
        ...
        try (HistoryIterator historyEntriesIterator =
          ...
          while (historyEntriesIterator.hasNext()) {
            ...
            extractor.parseEmbedded(
                InputStream.nullInputStream(), new IgnoreContentHandler(), historySubitem, true);
          }
        }
      }

      Metadata inventoryAppsMeta = new Metadata();
      try (BufferedOutputStream tmpInventoryAppFile =
          new BufferedOutputStream(new FileOutputStream(inventoryAppsFile))) {
        ToXMLContentHandler inventoryAppHandler =
            new ToXMLContentHandler(tmpInventoryAppFile, "UTF-8");
        String title = "Event Transcript Apps Inventory";
        inventoryAppsMeta.add(
            StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_INVENTORY_APP.toString());
        ...
        try (InventoryAppsIterator inventoryAppsIterator =
            new InventoryAppsIterator(connection, DBQueries.INVENTORY_APPS)) {
          XHTMLContentHandler xHandler =
              emitHeader(
                  inventoryAppHandler, inventoryAppsMeta, title, INVENTORY_APPS_COLUMN_NAMES);
          ...
          while (inventoryAppsIterator.hasNext()) {
            ...
            String[] values =
                new String[] {
                  appInvEntry.getName(),
                  appInvEntry.getTimestampStr(),
                  appInvEntry.getLocalTime(),
                  appInvEntry.getTimezone(),
                  appInvEntry.getVersion(),
                  appInvEntry.getPublisher(),
                  appInvEntry.getRootDirPath(),
                  appInvEntry.getInstallDateStr()
                };
      ...
      if (extractEntries) {
        try (InventoryAppsIterator inventoryAppsIterator =
          ...
          while (inventoryAppsIterator.hasNext()) {
            ...
            extractor.parseEmbedded(
                InputStream.nullInputStream(), new IgnoreContentHandler(), inventorySubitem, true);
          }
        }
      }

      Metadata appInteractMeta = new Metadata();
      try (BufferedOutputStream tmpAppInteractFile =
          new BufferedOutputStream(new FileOutputStream(appInteractivityFile))) {
        ToXMLContentHandler appInteractivityHandler =
            new ToXMLContentHandler(tmpAppInteractFile, "UTF-8");
        String title = "Event Transcript App Interactivity";
        appInteractMeta.add(
            StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_APP_INTERACT.toString());
        ...
        try (AppInteractivityIterator appInteractivityIterator =
            new AppInteractivityIterator(connection, DBQueries.APP_INTERACTIVITY)) {
          XHTMLContentHandler xHandler =
              emitHeader(
                  appInteractivityHandler, appInteractMeta, title, APP_INTERACT_COLUMN_NAMES);
          ...
          while (appInteractivityIterator.hasNext()) {
            ...
            String[] values =
                new String[] {
                  appIntEntry.getApp(),
                  appIntEntry.getTimestampStr(),
                  appIntEntry.getLocalTime(),
                  appIntEntry.getTimezone(),
                  appIntEntry.getType(),
                  appIntEntry.getWindowSize(),
                  appIntEntry.getMouseInputSec(),
                  appIntEntry.getInFocusDuration(),
                  appIntEntry.getUserActiveDuration()
                };
            emitEntry(xHandler, ++i, values);
          }
          xHandler.endElement("table");
      ...
      try (BufferedOutputStream tmpDevicesFile =
          new BufferedOutputStream(new FileOutputStream(devicesFile))) {
        ...
        try (DevicesIterator devicesIterator = new DevicesIterator(connection, DBQueries.DEVICES)) {
          XHTMLContentHandler xHandler =
              emitHeader(devicesHandler, devicesMeta, title, DEVICES_COLUMN_NAMES);
          ...
          while (devicesIterator.hasNext()) {
            ...
            String[] values =
                new String[] {
                  deviceEntry.getModel(),
                  deviceEntry.getTimestampStr(),
                  deviceEntry.getLocalTime(),
                  deviceEntry.getTimezone(),
                  deviceEntry.getInstanceId(),
                  deviceEntry.getProvider(),
                  deviceEntry.getManufacturer(),
                  deviceEntry.getInstallDateStr(),
                  deviceEntry.getEnumerator()
                };
            emitEntry(xHandler, ++i, values);
          }
          xHandler.endElement("table");
      ...
      if (extractEntries) {
        try (DevicesIterator devicesIterator = new DevicesIterator(connection, DBQueries.DEVICES)) {
          ...
          while (devicesIterator.hasNext()) {
            ...
            extractor.parseEmbedded(
                InputStream.nullInputStream(), new IgnoreContentHandler(), deviceSubitem, true);
          }
        }
      }

      Metadata censusMeta = new Metadata();
      try (BufferedOutputStream tmpCensusFile =
          new BufferedOutputStream(new FileOutputStream(censusFile))) {
        ...
        try (CensusIterator censusIterator = new CensusIterator(connection, DBQueries.CENSUS)) {
          XHTMLContentHandler xHandler =
              emitHeader(censusHandler, censusMeta, title, CENSUS_COLUMN_NAMES);
          ...
          while (censusIterator.hasNext()) {
            ...
            String[] values =
                new String[] {
                  censusEntry.getTimestampStr(),
                  censusEntry.getLocalTime(),
                  censusEntry.getTimezone(),
                  censusEntry.getEventName(),
                  censusEntry.getDataJSON()
                };
            emitEntry(xHandler, ++i, values);
          }
          xHandler.endElement("table");
      ...
      if (extractEntries) {
        try (CensusIterator censusIterator = new CensusIterator(connection, DBQueries.CENSUS)) {
          ...
          while (censusIterator.hasNext()) {
            ...
            extractor.parseEmbedded(
                InputStream.nullInputStream(), new IgnoreContentHandler(), censusSubitem, true);
          }
        }
      }

      Metadata networkingMeta = new Metadata();
      try (BufferedOutputStream tmpNetworkingFile =
          new BufferedOutputStream(new FileOutputStream(networkingFile))) {
        ...
        networkingMeta.add(
            StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_NETWORKING.toString());
        ...
        try (NetworkingIterator networkingIterator =
            new NetworkingIterator(connection, DBQueries.NETWORKING)) {
          XHTMLContentHandler xHandler =
              emitHeader(networkingHandler, networkingMeta, title, NETWORK_COLUMN_NAMES);
          ...
          while (networkingIterator.hasNext()) {
            ...
            String[] values =
                new String[] {
                  netEntry.getUTCTimestampStr(),
                  netEntry.getLocalTime(),
                  netEntry.getTimezone(),
                  netEntry.getEventName(),
                  netEntry.getEventSource(),
                  netEntry.getEventReason(),
      ...
      if (extractEntries) {
        try (NetworkingIterator networkingIterator =
          ...
          while (networkingIterator.hasNext()) {
            ...
            extractor.parseEmbedded(
                InputStream.nullInputStream(), new IgnoreContentHandler(), networkingSubitem, true);
          }
        }
      }
  ...
  private XHTMLContentHandler emitHeader(
      ContentHandler handler, Metadata metadata, String title, String[] colnames)
      throws SAXException {
  ...
  private Metadata getHistoryEntryMetadata(BrowserHistoryEntry historyEntry, int i)
    ...
    metadataHistoryEntry.add(
        StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_HIST_REG.toString());
    metadataHistoryEntry.add(
        TikaCoreProperties.RESOURCE_NAME_KEY, "Event Transcript History Entry " + i);
    ...
    metadataHistoryEntry.add(
        TikaCoreProperties.TITLE, String.join("; ", historyEntry.getPageTitles()));
  ...
  private Metadata getInventoryEntryMetadata(InventoryAppsEntry entry, int i)
      throws ParseException {
    Metadata metadataEntry = new Metadata();

    metadataEntry.add(
        StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_INVENTORY_APP_REG.toString());
    metadataEntry.add(
        TikaCoreProperties.RESOURCE_NAME_KEY, "Event Transcript Inventory App Entry " + i);
  ...
  private Metadata getAppInteractEntryMetadata(AppInteractivityEntry entry, int i)
      throws ParseException {
    Metadata metadataEntry = new Metadata();

    metadataEntry.add(
        StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_APP_INTERACT_REG.toString());
    metadataEntry.add(
        TikaCoreProperties.RESOURCE_NAME_KEY, "Event Transcript App Interaction " + i);
    metadataEntry.set(ExtraProperties.DECODED_DATA, Boolean.TRUE.toString());
  ...
  private Metadata getCensusEntryMetadata(CensusEntry entry, int i) throws ParseException {
    ...
    metadataCensusEntry.add(
        StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_CENSUS_REG.toString());
    metadataCensusEntry.add(
        TikaCoreProperties.RESOURCE_NAME_KEY, "Event Transcript Census Entry " + i);
  ...
  private Metadata getNetworkingMetadata(NetworkingEntry entry, int i) throws ParseException {
    ...
    metadataEntry.add(
        StandardParser.INDEXER_CONTENT_TYPE, EVENT_TRANSCRIPT_NETWORKING_REG.toString());
    metadataEntry.add(
        TikaCoreProperties.RESOURCE_NAME_KEY, "Event Transcript Networking Entry " + i);
    metadataEntry.set(ExtraProperties.DECODED_DATA, Boolean.TRUE.toString());
  ...
  private class HistoryIterator extends DBIterator<BrowserHistoryEntry> {
    ...
    public BrowserHistoryEntry next() {
      ...
      try {
        ...
        historyEntry.setPageTitles(
            pageTitlesStr != null ? pageTitlesStr.split(";") : new String[] {""});
  ...
  private class AppInteractivityIterator extends DBIterator<AppInteractivityEntry> {
    ...
    public AppInteractivityEntry next() {
      ...
      try {
        ...
        appInteractivityEntry.setUserOrDisplayActiveDuration(
            rs.getString("UserOrDisplayActiveDurationMS"));
