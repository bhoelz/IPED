...
public class ThreemaContact {
  ...
  public ThreemaContact(
      String firstName, String lastName, String nickName, String identity, String deviceID) {
  ...
  public String getId() {
    ...
    else if (deviceID != null && !deviceID.isBlank()) return deviceID;
    else return "";
  }
  ...
  public String getFullId() {
    ...
    else if (deviceID != null && !deviceID.isBlank()) return nickName + " (" + deviceID + ")";
