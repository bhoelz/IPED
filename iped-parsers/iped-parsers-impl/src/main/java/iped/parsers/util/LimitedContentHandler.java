...
/**
 * SAX event handler that writes content up to an write limit out to a character stream or other
 * decorated handler.
 */
public class LimitedContentHandler extends DefaultHandler {
  ...
  /**
   * Checks whether the given exception (or any of it's root causes) was thrown by this handler as a
   * signal of reaching the write limit.
   *
   * @since Apache Tika 0.7
   * @param t throwable
