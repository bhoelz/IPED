...
class ClassLoaderResource implements ForkResource {
  ...
  /**
   * Sends the contents of the given input stream to the given output. The stream is sent in chunks
   * of less than 64kB, each preceded by a 16-bit integer value that indicates the length of the
   * following chunk. A zero short value is sent at the end to signify the end of the stream.
   *
