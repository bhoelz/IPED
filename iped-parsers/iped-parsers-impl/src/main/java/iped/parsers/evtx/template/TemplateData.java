...
public class TemplateData {
  ...
  public TemplateData(EvtxFile evtxFile, ByteBuffer bb, TemplateInstance templateInstance)
    ...
    try {
      ...
      throw new EvtxParseException(
          "Not enough data to read template value descriptor in " + evtxFile.getName());
    }
  }
}
