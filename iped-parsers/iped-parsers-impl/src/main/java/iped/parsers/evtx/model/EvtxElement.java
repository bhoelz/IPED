...
public class EvtxElement {
  ...
  public EvtxElement(EvtxFile evtxFile, ByteBuffer bb, byte mode, EvtxElement parent)
    ...
    if ((token.type != BinXmlToken.LIBFWEVT_XML_TOKEN_CLOSE_START_ELEMENT_TAG)
        && (token.type != BinXmlToken.LIBFWEVT_XML_TOKEN_CLOSE_EMPTY_ELEMENT_TAG)) {
