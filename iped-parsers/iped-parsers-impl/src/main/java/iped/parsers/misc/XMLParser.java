...
/**
 * Parser customizado para arquivos XML. Usa um parser menos restrito que o parser padrão do Tika e
 * tb executa o parser de strings para indexar elementos e atributos.
 *
 * @author Nassif
 */
