...
public class PDFTextParserTest extends TestCase {
  ...
  public void testPDFOCRTextParsingICE() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_pdfProtected.pdf")) {
      ...
      assertEquals(
          "Acrobat Distiller 7.0.5 (Windows)", metadata.get(TikaCoreProperties.CREATOR_TOOL));
      ...
      assertEquals(
          "April 28, 2009 10:06:56 (UTC +01:00)", metadata.get(TikaCoreProperties.CREATED));
      assertEquals(
  ...
  public void testPDFOCRTextEmbbedHandler() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_pdfProtected.pdf")) {
      ...
      assertTrue(
          hts.contains("This paper considers the financial system as a complex adaptive system."));
      assertTrue(
          hts.contains(
