...
public class OCRParserTest {
  ...
  public static void setUpTool() throws IOException {
    if (osName.startsWith("windows")) {
      String repoPath =
          "tesseract/tesseract-zip/5.3.2-24-g3922_1/tesseract-zip-5.3.2-24-g3922_1.zip";
  ...
  public void testOCRParserPNG() throws IOException, SAXException, TikaException, SQLException {
    ...
    ItemInfo itemInfo =
        new ItemInfo(0, testName.getMethodName(), null, null, testName.getMethodName(), false);
  ...
  @Test
  public void testOCRParserSVG()
      throws IOException, SAXException, TikaException, SQLException, InterruptedException {
    Metadata metadata = new Metadata();
    ContentHandler handler = new BodyContentHandler();
    ParseContext context = new ParseContext();
    ItemInfo itemInfo =
  ...
  private void setUpImageMagick() throws IOException {
    if (System.getProperty(ExternalImageConverter.enabledProp, "").isEmpty()) {
      ...
      if (osName.startsWith("windows")) {
        String repoPath =
            "org/imagemagick/imagemagick-zip/7.1.1-19-q8-x64/imagemagick-zip-7.1.1-19-q8-x64.zip";
