...
public class WhatsAppParserTest extends AbstractPkgTest {
  ...
  public void testWhatsAppParserAndroid() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream(testFile)) {
      ...
      assertEquals(
          "WhatsApp Chat - Nickerida - 556183125151_message_0", whatsapptracker.title.get(1));
      assertEquals(
          "WhatsApp Chat - Nickerida - 556183125151_message_1", whatsapptracker.title.get(2));
      assertEquals(
          "WhatsApp Chat - Nickerida - 556183125151_message_2", whatsapptracker.title.get(3));
      assertEquals(
          "WhatsApp Chat - Nickerida - 556183125151_message_3", whatsapptracker.title.get(4));
      assertEquals(
          "WhatsApp Group - Lar - 556185747642-1461964508_message_1",
          whatsapptracker.title.get(61));
      assertEquals(
          "WhatsApp Group - Lar - 556185747642-1461964508_message_2",
          whatsapptracker.title.get(62));
      ...
      assertEquals(
          "This is a test for the IPED Whatsapp Parser.", whatsapptracker.messagebody.get(0));
  ...
  public void testWhatsAppParserWADBAndroid() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream(testFile)) {
      ...
      assertEquals(
          "\"Nobility is about being superior than your former self\"",
