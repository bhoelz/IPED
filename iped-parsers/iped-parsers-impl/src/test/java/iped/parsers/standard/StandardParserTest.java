...
public class StandardParserTest extends TestCase {
  ...
  @Test
  public void testIndexerDefaultParserParsingImage()
  ...
  @Test
  public void testIndexerDefaultParserParsingVideo()
      throws IOException, SAXException, TikaException {
  ...
  @Test
  public void testIndexerDefaultParserParsingDocument()
      throws IOException, SAXException, TikaException {
  ...
  @Test
  public void testIndexerDefaultParserParsingText()
      throws IOException, SAXException, TikaException {
  ...
  @Test
  public void testIndexerDefaultParserParsingPackage()
      throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_mockRar4.rar")) {
      ...
      assertTrue(
          hts.contains("Indexer-Content-Type: " + SevenZipParser.RAR.toString() + "; version=4"));
      assertTrue(hts.contains(PARSED_BY + ": " + RarParser.class.getName()));

      assertEquals(
          SevenZipParser.RAR.toString() + "; version=4", metadata.get(INDEXER_CONTENT_TYPE));
      assertEquals(RarParser.class.getName(), metadata.get(PARSED_BY));
      assertEquals(
          SevenZipParser.RAR.toString() + "; version=4", metadata.get(Metadata.CONTENT_TYPE));
    }
  }
  ...
  public void testIndexerDefaultParserParsingPDF() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_pdfResumes.pdf")) {
      ...
      assertTrue(
          hts.contains("Education Massachusetts Institute of Technology (MIT) Cambridge, MA"));
      ...
      assertTrue(
          hts.contains(
              "pdf:charsPerPage: 2767 2772 2990 3056 3204 3614 3627 3796 3971 3988 4242 4462 4683 64"));
      assertTrue(
          hts.contains(
      ...
      assertTrue(
          hts.contains(
              "pdf:xmpMM:DerivedFrom:DocumentID: xmp.did:f3bb53b2-ad53-4b82-8274-0773472726fc"));
      assertTrue(
          hts.contains(
              "pdf:xmpMM:DerivedFrom:InstanceID: xmp.iid:367905db-1695-4b2f-853d-67618bdd58a9"));
  ...
  @Test
  public void testIndexerDefaultParserParsingUnknownFileLua()
      throws IOException, SAXException, TikaException {
  ...
  @Test
  public void testIndexerDefaultParserParsingUnknownFile()
      throws IOException, SAXException, TikaException {
  ...
  @Test
  public void testIndexerDefaultParserParsingEncryptedDoc()
      throws IOException, SAXException, TikaException {
