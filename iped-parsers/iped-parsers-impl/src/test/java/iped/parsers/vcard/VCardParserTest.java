...
public class VCardParserTest extends TestCase {
  ...
  @Test
  public void testVCardCompleteInfoParser()
    ...
    if (getVersion() < 9) {
      try (InputStream stream = getStream("test-files/test_contactsCompleteInfo.vcf")) {
        ...
        assertTrue(
            hts.contains("gosta muito de dançar para-pararato rato rato: esse cara é o rato"));

        assertEquals(
            "R. da Casa do Prof. Elder isso mesmo Bela Vista MS BR ZIP 79260-000",
            useraddresses[0]);
  ...
  @Test
  public void testVCardCompleteWithoutThumbParser()
    ...
    try (InputStream stream = getStream("test-files/test_contactsCompleteWithoutThumb.vcf")) {
      ...
      assertEquals(
          "R. da Casa do Prof. Elder isso mesmo Bela Vista MS BR ZIP 79260-000", useraddresses[0]);
      assertEquals("www.rato.com.br", userurls[0]);
      assertEquals("insuportavel@test.paraparapara", useremails[0]);
  ...
  @Test
  public void testVCardHtmlFromString()
