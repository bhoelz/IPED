...
public class Message implements Comparable<Message> {
  ...
  static {
    try {
      ...
      fileChannel =
          FileChannel.open(thumbsfile.toPath(), StandardOpenOption.READ, StandardOpenOption.WRITE);
    } catch (IOException e) {
  ...
  /**
   * Deleted recovered messages may have the same id as an allocated message. This returns a global
   * unique id for a decoded database. Calls can also have the same id, so a new info is used as id
   *
  ...
  public void setMediaHash(String mediaHash, boolean encoded) {
    if (mediaHash == null || mediaHash.isEmpty()) return;
    if (encoded) {
  ...
  public boolean isCall() {
    return messageType == MessageType.VIDEO_CALL
        ...
        || messageType == MessageType.REFUSED_VIDEO_CALL
        || messageType == MessageType.REFUSED_VOICE_CALL
        || messageType == MessageType.UNKNOWN_VOICE_CALL
        || messageType == MessageType.UNKNOWN_VIDEO_CALL;
  }
  ...
  public static enum MessageType {
    ...
    DELETED_BY_SENDER,
    GROUP_CREATED,
    USER_ADDED_TO_COMMUNITY,
    USER_ADDED_TO_GROUP,
    USER_JOINED_GROUP_FROM_COMMUNITY,
    USER_JOINED_GROUP_FROM_LINK,
    USER_JOINED_GROUP_FROM_INVITATION,
    USER_LEFT_GROUP,
    USER_REMOVED_FROM_GROUP,
    USER_COMMUNITY_ADMIN,
    URL_MESSAGE,
    GROUP_ICON_CHANGED,
    GROUP_ICON_DELETED,
    ...
    REFUSED_VIDEO_CALL,
    REFUSED_VOICE_CALL,
    UNAVAILABLE_VIDEO_CALL,
    UNAVAILABLE_VOICE_CALL,
    UNKNOWN_VOICE_CALL,
    UNKNOWN_VIDEO_CALL,
    ...
    CALL_MESSAGE,
    BUSINESS_META_SECURE_SERVICE,
    GROUP_INVITE,
    TEMPLATE_MESSAGE,
    TEMPLATE_QUOTE,
    POLL_MESSAGE,
    EPHEMERAL_DURATION_CHANGED,
    EPHEMERAL_SETTINGS_NOT_APPLIED,
    EPHEMERAL_CHANGED,
    EPHEMERAL_DEFAULT,
    EPHEMERAL_SAVE,
    GROUP_CHANGED_ONLY_ADMINS_CAN_ADD,
    GROUP_CHANGED_ONLY_ADMINS_CAN_SEND,
    GROUP_CHANGED_ALL_MEMBERS_CAN_SEND,
    GROUP_CHANGED_ONLY_ADMINS_CAN_EDIT,
    GROUP_CHANGED_ALL_MEMBERS_CAN_EDIT,
    GROUP_ONLY_ADMINS_CAN_SEND,
    CHANGED_DEVICE,
    CHANGED_NUMBER_TO,
    CHANGED_NUMBER_CHATTING_WITH_NEW,
    CHANGED_NUMBER_CHATTING_WITH_OLD,
    STANDARD_CHAT,
    SENDER_ADDED_TO_CONTACTS,
    SENDER_IN_CONTACTS,
    BUSINESS_OFFICIAL,
    GROUP_ADDED_TO_COMMUNITY,
    GROUP_REMOVED_FROM_COMMUNITY,
    COMMUNITY_MANAGEMENT_ACTION,
    COMMUNITY_WELCOME,
    UI_ELEMENTS,
    UI_ELEMENTS_QUOTE,
    CHAT_ADDED_PRIVACY,
    CHANNEL_ADDED_PRIVACY,
    CHANNEL_CREATED,
    ORDER_MESSAGE,
    PRODUCT_MESSAGE,
    BUSINESS_CHANGED_NAME,
    USER_JOINED_WHATSAPP,
    PINNED_MESSAGE,
    GROUP_NAME_CHANGED,
    AI_THIRD_PARTY,
    ...
    RESET_GROUP_LINK,
    COMMUNITY_RENAMED,
    ANY_COMMUNITY_MEMBER_CAN_JOIN_GROUP,
    UNKNOWN_MESSAGE,
    OVER_256_MEMBERS_ONLY_ADMINS_CAN_EDIT,
    SECURITY_NOTIFICATIONS_NO_LONGER_AVAILABLE,
    CONTACTED_FIND_BUSINESSES,
    COMMUNITY_CHANGED_ONLY_ADMINS_CAN_ADD,
    COMMUNITY_CHANGED_ALL_MEMBERS_CAN_ADD,
    COMMUNITY_DESCRIPTION_CHANGED,
    COMMUNITY_NOT_AVAILABLE,
    GROUP_NOT_PART_OF_COMMUNITY,
    GROUP_CHANGED_ADMIN_APPROVAL_OFF,
    GROUP_CHANGED_ALL_MEMBERS_CAN_ADD,
    USER_REQUEST_TO_ADD_TO_GROUP,
    CHAT_STARTED_FROM_AD,
    MESSAGE_ASSOCIATION,
    ADVANCED_PRIVACY_ON,
    IGNORE_MESSAGE
  }
