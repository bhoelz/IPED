...
public class WAContact {
  ...
  public String getName() {
    ...
    else if (waName != null && !waName.isBlank()) return waName;
    else if (givenName != null && !givenName.isBlank()) return givenName;
    else if (nickName != null && !nickName.isBlank()) return nickName;
    else return id;
  }
