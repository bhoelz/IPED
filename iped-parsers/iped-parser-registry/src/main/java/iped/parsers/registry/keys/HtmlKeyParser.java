...
public class HtmlKeyParser implements RegistryKeyParser {
  ...
  private byte[] generateKeyNodeHtml(KeyNode kn, String keyPath)
    ...
    out.println(
        "<p font=\"-2\">(*) conteúdo não decodificado, ou sem decodificador encontrado. </p>");
  ...
  private String execute(String function, String keyValueName)
  ...
  private String execute(String function, KeyValue keyValue)
      throws NoSuchMethodException, ScriptException {
    Invocable inv = RegistryKeyParserManager.getRegistryKeyParserManager().getInv();
