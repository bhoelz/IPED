...
/**
 * This class replaces the library net.dongliu.apk.parser.ApkFile, that uses MappedByteBuffer which
 * may hold a reference to the file being parsed, until it is garbage collected, preventing the
