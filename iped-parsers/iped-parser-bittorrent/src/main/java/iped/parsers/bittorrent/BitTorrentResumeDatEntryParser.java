...
public class BitTorrentResumeDatEntryParser extends AbstractParser {
  ...
  private static final Set<MediaType> SUPPORTED_TYPES =
      Collections.singleton(MediaType.application("x-bittorrent-resume-dat-entry"));
  public static final String RESUME_DAT_ENTRY_MIME_TYPE =
      "application/x-bittorrent-resume-dat-entry";
  ...
  public void parse(
    ...
    final DateFormat df =
        new SimpleDateFormat(Messages.getString("BitTorrentResumeDatParser.DateFormat"));
