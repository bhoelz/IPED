...
public class TransmissionResumeParser extends AbstractParser {
  ...
  private static final Set<MediaType> SUPPORTED_TYPES =
      Collections.singleton(MediaType.application("x-transmission-resume"));
  ...
  public void parse(
    ...
    final DateFormat df =
        new SimpleDateFormat(Messages.getString("TransmissionResumeParser.DateFormat"));
    ...
    xhtml.characters(
        ".dt {border-collapse: collapse; font-family: Arial, sans-serif; } "
      ...
      if (p1 > 0) {
        ...
        if (p0 > 0) {
          ...
          if (parent.equalsIgnoreCase("resume")) {
            ...
            return new String[] {
              base + path.substring(p1, p2) + ".torrent",
