...
public class UsnJrnlParser extends AbstractParser {
  ...
  public static final MediaType USNJRNL_REPORT_HTML =
      MediaType.parse("application/x-usnjournal-report-html");
  public static final MediaType USNJRNL_REPORT_CSV =
      MediaType.parse("application/x-usnjournal-report-csv");
  public static final MediaType USNJRNL_REGISTRY =
      MediaType.parse("application/x-usnjournal-registry");
  ...
  private void createReport(
      ArrayList<UsnJrnlEntry> entries,
      int n,
  ...
  private void rebuildFullPaths(
      List<UsnJrnlEntry> entries, IItemSearcher searcher, IItemReader item) {
