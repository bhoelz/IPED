...
public class TorParserTest {
  ...
  public void testTorParser1() throws IOException, SAXException, TikaException {
    ...
    try (stream) {
      ...
      assertEquals(
          ...
          metadata.get(TorTcParser.TORTC_REND_QUERY));
      assertEquals("2023-07-03T17:05:24.214215Z", metadata.get(TorTcParser.TORTC_TIME_CREATED));
      assertEquals(
          "\"facebookwkhpilnemxj7asaniu7vnjjbiltxjqhye3mhbshg7kx5tfyd.onion\"",
          metadata.get(TorTcParser.TORTC_SOCKS_USERNAME));
      assertEquals(
          "\"8b855a9b98c96ce9b877a17397d59945\"", metadata.get(TorTcParser.TORTC_SOCKS_PASSWORD));
    }
  }
  ...
  public void testTorParser2() throws IOException, SAXException, TikaException {
    ...
    try (stream) {
      ...
      assertEquals("HS_CLIENT_REND", metadata.get(TorTcParser.TORTC_PURPOSE));
      assertEquals(
          "facebook26qderizo52pigg5y4a2jsdhqz4odvvusaij4yhxehqngqad",
          metadata.get(TorTcParser.TORTC_REND_QUERY));
