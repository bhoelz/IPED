...
public class OutlookPSTParserTest extends AbstractPkgTest {
  ...
  protected static class EmbeddedPSTParser extends AbstractParser {
    ...
    public void parse(
      ...
      if (metadata.get(Metadata.COMMENT) != null) foldercomment.add(metadata.get(Metadata.COMMENT));
      // messages
  ...
  @Test
  public void testOutlookPSTParserMetadataSimpleMessage()
      throws IOException, SAXException, TikaException {
  ...
  @Test
  public void testOutlookPSTParserMetadataRealMessages()
      throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_sample.pst")) {
      ...
      assertEquals(
          "Re: [sepinf-inc/IPED] WIP Parsers tests (#481)", psttracker.messagesubject.get(1));
      assertEquals(
      ...
      assertEquals(
          "Re: Solicita documentação para contrato de estágio na DITEC/PF.",
  ...
  @Test
  public void testOutlookPSTParserMetadataMessageAttach()
      throws IOException, SAXException, TikaException {
  ...
  @Test
  public void testOutlookPSTParserMetadataUserInfo()
      throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_sample.pst")) {
      ...
      assertEquals(
          "Condomínio da imaginação ruas dos bobos número 0", psttracker.useraddress.get(0));
