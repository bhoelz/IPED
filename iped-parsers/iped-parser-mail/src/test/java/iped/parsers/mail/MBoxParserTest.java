...
public class MBoxParserTest extends AbstractPkgTest {
  ...
  public void testMboxMetadata() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_mbox.mbox")) {
      ...
      assertEquals(
          "Re: Da uma olhada nesse jogo, acho que você vai gostar!",
          mboxtracker.messagesubject.get(1));
      ...
      assertEquals(
          "Da uma olhada nesse jogo, acho que você vai gostar!", mboxtracker.messagesubject.get(2));
