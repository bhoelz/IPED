...
public class MboxParser extends AbstractParser {
  ...
  private static final Set<MediaType> SUPPORTED_TYPES =
      Collections.singleton(MediaType.application("mbox")); // $NON-NLS-1$
          ...
          try {
            ...
            do {
              ...
              line = reader.readLine();
                ...
                && !line.startsWith(MBOX_RECORD_DIVIDER)
            ...
            if (count == 1) throw new TikaException("MboxParser Exception", t); // $NON-NLS-1$

            log.warn(
                "Error extracting email {} from {}\t{}", count, name, t.toString()); // $NON-NLS-1$
          }
        }
