...
public class Index {
  ...
  private static final long MAGIC_NUMBER_LE = 0xC103CAC3l; // magic number in little endian
  private static final List<Long> supportedVersions = ImmutableList.of(0x00020001l, 0x00030000l);
  ...
  public Index(
      InputStream is, String path, List<IItemReader> dataFiles, List<IItemReader> externalFiles)
