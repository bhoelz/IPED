...
public class ShareazaSearchesDatParser extends AbstractParser {
  ...
  private static final Set<MediaType> SUPPORTED_TYPES =
      Collections.singleton(MediaType.application("x-shareaza-searches-dat")); // $NON-NLS-1$
  public static final String SEARCH_DAT_MIME_TYPE =
      "application/x-shareaza-searches-dat"; //$NON-NLS-1$
