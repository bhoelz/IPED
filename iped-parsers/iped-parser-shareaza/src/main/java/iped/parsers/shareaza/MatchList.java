...
class MatchList extends ShareazaEntity {
  ...
  protected void writeImpl(ShareazaOutputGenerator f) {
    ...
    f.out(
        "Filter .. Busy: %s, Push: %s, Unstable: %s, Reject: %s, Local: %s, Bogus: %s", //$NON-NLS-1$
        "" + filterBusy,
        "" + filterPush,
        "" + filterUnstable, // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        "" + filterReject,
        "" + filterLocal,
        "" + filterBogus); // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    f.out(
        "Filter .. DRM: %s, Adult: %s, Suspicious: %s, RegExp: %s", //$NON-NLS-1$
        "" + filterDRM,
        "" + filterAdult,
        "" + filterSuspicious,
        "" + bRegExp); // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
