...
public class ShareazaSearchesDatParserTest extends TestCase {
  ...
  public void testShareazaSearchesDatParser() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_shareazaSearches.dat")) {
      ...
      assertTrue(
          hts.contains(
              "ed2kftp://7191240@91.208.184.143:4232/4d29a8f82cfca1f5f987de6f16714a61/4753906/"));
      assertEquals(
          ShareazaSearchesDatParser.SEARCH_DAT_MIME_TYPE, metadata.get(Metadata.CONTENT_TYPE));
    }
  }
}
