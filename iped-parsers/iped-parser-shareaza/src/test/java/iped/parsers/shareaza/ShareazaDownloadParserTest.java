...
public class ShareazaDownloadParserTest extends BaseItemSearchContext {
  ...
  public void testShareazaDownloadParser() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream(file)) {
      ...
      assertTrue(
          hts.contains(
              "TIGER:                   CF9F77A8B2DB58844EE3CB6E3C68D832A333E22980D11EAC"));
      ...
      assertEquals(
          ...
          Boolean.parseBoolean(
              metadata.get("p2p:shared"))); // false because p2p:totalDownloaded == 0
      ...
      assertEquals(
          ShareazaDownloadParser.SHAREAZA_DOWNLOAD_META, metadata.get(Metadata.CONTENT_TYPE));
