 ...
 *
 * <p>Fetching rocord is possible only in the forward direction and cannot re-wound. In such
 * situation, a suggested approach is to reconstruct the object.
 *
...
public class DBFReader extends DBFBase {
   ...
   *
   * <p>When this constructor returns the object will have completed reading the hader (meta date)
   * and header information can be quried there on. And it will be ready to return the first row.
   *
  ...
  public DBFReader(InputStream in) throws DBFException {
    ...
    try {
      ...
      int t_dataStartIndex =
          this.header.headerLength - (32 + (32 * this.header.fieldArray.length)) - 1;
   ...
   *
   * @returns The next row as an Object array. Types of the elements these arrays follow the
