...
public class CertificateParser extends AbstractParser {
  ...
  public static final Property NOTBEFORE =
      Property.internalDate("certificate:notbefore"); // $NON-NLS-1$
  public static final Property NOTAFTER =
      Property.internalDate("certificate:notafter"); // $NON-NLS-1$
  ...
  public static final Property ISSUBJECTAUTHORITY =
      Property.internalBoolean("certificate:subjectIsCertAuthority"); // $NON-NLS-1$
  ...
  public void parse(
    ...
    try {
      ...
      metadata.set(
          TikaCoreProperties.TITLE, "Certificado:" + cert.getSubjectX500Principal().getName());
