...
public class KeystoreParser extends AbstractParser {
  ...
  private static final Set<MediaType> SUPPORTED_TYPES =
      new HashSet<>(Arrays.asList(PKCS12_MIME, JAVA_KEYSTORE));
  public static final Property PRIVATEKEY =
      Property.internalText("certificate:privatekey"); // $NON-NLS-1$
    ...
    try {
      ...
      if (!loaded) {
        ...
        throw new EncryptedDocumentException(
            "Documento encriptado com senha diferente das senhas tentadas.");
      }
