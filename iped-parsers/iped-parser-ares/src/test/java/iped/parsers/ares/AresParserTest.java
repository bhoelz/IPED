...
public class AresParserTest extends TestCase {
  ...
  public void testAresParserParsingShareL() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_shareL.dat")) {
      ...
      assertTrue(
          hts.contains(
              "c:\\Users\\guilh\\OneDrive\\Área de Trabalho\\PF\\test-files\\cpio\\mocktext2.txt"));
      assertTrue(
          hts.contains(
              "c:\\Users\\guilh\\OneDrive\\Área de Trabalho\\PF\\test-files\\cpio\\mockfolder\\mocktext5.txt"));
      assertTrue(
          hts.contains(
              "c:\\Users\\guilh\\OneDrive\\Área de Trabalho\\PF\\test-files\\cpio\\mocktext1.txt"));
    }
  }
  ...
  public void testAresParserEmbeddedShareL() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_shareL.dat")) {
      ...
      assertEquals(
          "3caf8ead5f326604bfbc7eae5274a15fb7840d08", metadata.get(ExtraProperties.SHARED_HASHES));
    }
  }
  ...
  public void testAresParserEmbeddedShareH() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_shareH.dat")) {
      ...
      assertEquals(
          "8a199330e3882ff26a4b02e8285f5a9dc20d1ef1", metadata.get(ExtraProperties.SHARED_HASHES));
    }
  }
}
