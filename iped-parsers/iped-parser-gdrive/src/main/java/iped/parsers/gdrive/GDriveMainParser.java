...
/**
 * Google Drive Forensic artifacts main parser This class selects the appropriate parser for the
 * current artifact
 *
...
public class GDriveMainParser extends AbstractParser {
  ...
  public static final MediaType GDRIVE_ACCOUNT_INFO =
      MediaType.application("x-gdrive-account-info");

  private static final Set<MediaType> SUPPORTED_TYPES =
      MediaType.set(GDRIVE_CLOUD_GRAPH, GDRIVE_SNAPSHOT, GDRIVE_ACCOUNT_INFO);
