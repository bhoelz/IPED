...
public class ReportGenerator {
    ...
    private TagHtml getThumbTag(Message m, String classnotfound) {
        ...
        if (thumb != null) {
            ...
            img.setAtribute("src",
                    "data:image/jpg;base64," + Util.encodeBase64(thumb));
        } else {
            img = new TagHtml("div");
    ...
    private void printVideo(PrintWriter out, Message message) {
        ...
        if (message.getMediaHash() != null) {
            ...
            String reportSource = Util.getExportPath(message.getMediaHash(),
    ...
    private static void printMessageFileHeader(PrintWriter out, String title, byte[] avatar,
        ...
        out.println("<!DOCTYPE html>\n" //$NON-NLS-1$
                ...
                + Util.readResourceAsString("js/whatsapp.js") + "</script>"
        ...
        if (avatar != null) {
            out.println(
                    "<img src=\"data:image/jpg;base64," + Util.encodeBase64(avatar) //$NON-NLS-1$
