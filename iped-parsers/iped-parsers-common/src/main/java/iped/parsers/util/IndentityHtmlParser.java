...
public class IndentityHtmlParser {
  ...
  public void parse(InputStream is, ParseContext context, ContentHandler handler)
   ...
   * namespaces (and namespaced attributes) and uppercasing all element names.
   *
   * <p>Copied from org.apache.tika.parser.html.XHTMLDowngradeHandler with some adjusts: - drop HTML
   * elements - drop BODY elements - drop HEAD elements
   */
