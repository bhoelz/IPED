...
public class P2PUtil {
  ...
  public static void printNameWithLink(XHTMLContentHandler xhtml, IItemReader item, String name)
      throws SAXException {
    String hashPath =
        getPathFromHash(
            new File("../../../../", ExportFolder.getExportPath()), item.getHash(), item.getExt());
