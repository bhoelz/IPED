...
/**
 * Abstract base class for building display strings for a chat party
 * (sender / recipient) in a platform-specific format.
 *
 * <p>Lives in {@code iped-parsers-common} so that individual parser modules
 * (e.g. {@code iped-parser-whatsapp}) can subclass it without depending on
 * {@code iped-parsers-impl}.
 */
