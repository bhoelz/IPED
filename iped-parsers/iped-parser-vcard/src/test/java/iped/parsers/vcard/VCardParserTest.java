...
/**
 * Unit tests for VCardParser that do not require charset detection services. Full parse integration
 * tests exist in iped-parsers-impl (which has the full Tika stack on the classpath).
 */
