...
public class Attachment extends BaseModel {
  ...
  public String getFilename() {
    return (String) getField("Filename");
  }

  public String getContentType() {
    return (String) getField("ContentType");
  }
  ...
  public String getTranscript() {
    return (String) getField("Transcript");
  }

  public String getAttachmentExtractedPath() {
    return StringUtils.replaceChars((String) getField("attachment_extracted_path"), '\\', '/');
  }
