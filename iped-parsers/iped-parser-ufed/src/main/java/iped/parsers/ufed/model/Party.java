...
import iped.parsers.chat.IParty;
...
public class Party extends BaseModel implements IParty {
  ...
  public Date getDateDelivered() {
    return (Date) getField("DateDelivered");
  }

  public Date getDateRead() {
    return (Date) getField("DateRead");
  }

  public Date getDatePlayed() {
    return (Date) getField("DatePlayed");
  }
  ...
  @Override
  public Optional<? extends IReferencedContact> getReferencedContact() {
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(getIdentifier(), other.getIdentifier()).isEquals();
  }
}
