...
public class ChatActivity extends BaseModel {
  ...
  public String getAction() {
    return (String) getField("Action");
  }

  public UUID getSystemMessageId() {
    return (UUID) getField("SystemMessageId");
  }

  public Date getSystemMessageTimeStamp() {
    return (Date) getField("SystemMessageTimeStamp");
  }

  public String getSystemMessageBody() {
    return (String) getField("SystemMessageBody");
  }
