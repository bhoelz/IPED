...
public class Chat extends BaseModel {
  ...
  private final transient ConcurrentHashMap<String, InstantMessage> messagesByIdentifier =
      new ConcurrentHashMap<>();
  private final transient ConcurrentHashMap<String, InstantMessage> messagesByUfedId =
      new ConcurrentHashMap<>();
  ...
  public String getServiceIdentifier() {
    return (String) getField("ServiceIdentifier");
  }
  ...
  public Date getStartTime() {
    return (Date) getField("StartTime");
  }

  public Date getLastActivity() {
    return (Date) getField("LastActivity");
  }

  public String getAccount() {
    return (String) getField("Account");
  }

  public String getChatType() {
    return (String) getField("ChatType");
  }
