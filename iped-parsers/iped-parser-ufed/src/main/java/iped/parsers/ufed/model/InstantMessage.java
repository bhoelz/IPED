...
public class InstantMessage extends BaseModel implements Comparable<InstantMessage> {
  ...
  public String getPlatform() {
    return (String) getField("Platform");
  }
  ...
  public Date getTimeStamp() {
    return (Date) getField("TimeStamp");
  }
  ...
  public String getSourceApplication() {
    return (String) getField("SourceApplication");
  }

  public boolean isLocationSharing() {
    return BooleanUtils.toBoolean((Boolean) getField("IsLocationSharing"));
  }
  ...
  public boolean hasLabel(String label) {
    return messageExtraData.getMessageLabels().stream()
        .anyMatch(l -> label.equalsIgnoreCase(l.getLabel()));
  }
  ...
  public boolean isReplyMessage() {
    return messageExtraData.getReplyMessage().isPresent()
        ...
        || messageExtraData
            .getQuotedMessage()
            .filter(q -> "Reply".equalsIgnoreCase(q.getLabel()))
            .isPresent();
  }
  ...
  public boolean isForwardedMessage() {
    return messageExtraData.getForwardedMessage().isPresent()
        ...
        || messageExtraData
            .getQuotedMessage()
            .filter(q -> "Forwarded".equalsIgnoreCase(q.getLabel()))
            .isPresent();
  }

  public Party findForwardedMessageOriginalSender(Chat chat) {
    Optional<Party> originalSender =
        messageExtraData.getForwardedMessage().map(ForwardedMessageData::getOriginalSender);
  ...
  public InstantMessage findReplyMessage(Chat chat) {
    ...
    Optional<InstantMessage> replyMessage =
        messageExtraData.getReplyMessage().map(ReplyMessageData::getInstantMessage);
  ...
  public InstantMessage findQuotedMessage(Chat chat) {
    ...
    Optional<InstantMessage> quotedMessage =
        messageExtraData
            .getQuotedMessage()
  ...
  private InstantMessage findMessageUsingOriginalMessageId(String originalMessageID, Chat chat) {
    ...
    if (embeddedMessage != null
        && StringUtils.equals(embeddedMessage.getIdentifier(), originalMessageID)) {
