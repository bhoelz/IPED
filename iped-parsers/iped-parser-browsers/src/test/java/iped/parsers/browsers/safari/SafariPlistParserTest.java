...
public class SafariPlistParserTest extends AbstractPkgTest {
  ...
  public void testSafariPlistParserDownloads() throws IOException, SAXException, TikaException {
    ...
    try (InputStream stream = getStream("test-files/test_downloads.plist")) {
      ...
      assertEquals(
          "C:\\Documents and Settings\\guileb\\Meus documentos\\ChromeSetup.exe",
          safaritrackerdwl.downloadlocalpath.get(0));
      assertEquals(
          "C:\\Documents and Settings\\guileb\\Meus documentos\\Opera_winxpvista_36.0.2130.80_Setup.exe",
          safaritrackerdwl.downloadlocalpath.get(1));
      assertEquals(
          "C:\\Documents and Settings\\guileb\\Meus documentos\\Firefox Setup 52.9.0esr.exe",
