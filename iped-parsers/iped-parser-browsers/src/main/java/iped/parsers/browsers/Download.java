...
public class Download {
  ...
  public Download(
      String id, Long downloadedTime, String urlFromDownload, String downloadedLocalPath) {
    this.id = id;
    this.urlFromDownload = urlFromDownload;
    this.downloadedLocalPath = downloadedLocalPath;
    if (downloadedTime != null) this.downloadedDate = new Date(downloadedTime);
  }

  public Download(
      String id,
      Long downloadedTime,
      String urlFromDownload,
