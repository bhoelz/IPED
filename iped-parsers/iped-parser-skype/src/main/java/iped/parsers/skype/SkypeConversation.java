...
public class SkypeConversation {
  ...
  public String getTitle() {
    if (chatName != null) {
      return Messages.getString("SkypeConversation.SkypeChat")
          + id
          + "-"
          + chatName; //$NON-NLS-1$ //$NON-NLS-2$
    } else if (displayName != null) {
      return Messages.getString("SkypeConversation.SkypeChat")
          + id
          + "-"
          + displayName; //$NON-NLS-1$ //$NON-NLS-2$
    } else return Messages.getString("SkypeConversation.SkypeChat") + id; // $NON-NLS-1$
  }
