...
public class ExternalParserTest implements ExternalParsersConfigReaderMetKeys {
  ...
  private static ExternalParser superfetchParser,
      prefetchParser,
      recyclebinParser,
      recyclebinInfo2Parser,
      evtxLogParser,
      evtLogParser,
      metadataExtractionParser;

  private static ExternalParserConfigGenerator createExternalParserConfig(
      String name,
      String toolPath,
      String checkCmd,
      String cmd,
      String mimeType,
      int firstLinesToIgnore,
      String charset,
      String... matchPatterns)
      throws TikaException, TransformerException {
  ...
  public static void setUp()
    ...
    if (osName.startsWith("windows")) {
      ...
      repoPaths.add(
          "abelcheung/rifiuti2/0.7.0/rifiuti2-0.7.0.zip"); // recyclebin and recyclebinINFO2 parsers
    ...
    ExternalParserConfigGenerator superfetchConfigGenerator =
        createExternalParserConfig(
            "SuperFetchParser",
            tmpPath + "libagdb/",
            "agdbinfo -V",
            "agdbinfo ${INPUT}",
    ...
    ExternalParserConfigGenerator prefetchConfigGenerator =
        createExternalParserConfig(
            "PrefetchParser",
            tmpPath + "sccainfo/",
            "sccainfo -V",
    ...
    ExternalParserConfigGenerator recyclebinConfigGenerator =
        createExternalParserConfig(
            "RecycleBinParser",
            tmpPath + "rifiuti2/",
            "rifiuti-vista -v",
    ...
    ExternalParserConfigGenerator recyclebinInfo2ConfigGenerator =
        createExternalParserConfig(
            "RecycleInfo2Parser",
            tmpPath + "rifiuti2/",
            "rifiuti2 -v",
    ...
    ExternalParserConfigGenerator evtxLogConfigGenerator =
        createExternalParserConfig(
            "EvtxLogParser",
            tmpPath + "evtxexport/",
            "evtxexport -V",
    ...
    ExternalParserConfigGenerator evtLogConfigGenerator =
        createExternalParserConfig(
            "EvtLogParser",
            tmpPath + "evtexport/",
            "evtexport -V",
    ...
    ExternalParserConfigGenerator evtxMetaConfigGenerator =
        createExternalParserConfig(
            "EvtxLogMetadataParser",
            tmpPath + "evtxexport/",
            "evtxexport -V",
            "evtxexport ${INPUT}",
            "x-elf-file",
  ...
  @Test
  public void testSuperFetch()
      throws IOException, TikaException, SAXException, TransformerException {
  ...
  public void testPreFetch() throws IOException, TikaException, SAXException, TransformerException {
    ...
    try (InputStream stream = this.getClass().getResourceAsStream("/test-files/" + fileName)) {
      ...
      assertTrue(
          hts.toLowerCase()
              .contains(
                  "users\\felipe costa\\appdata\\local\\microsoft\\teams\\current\\teams.exe"));
    }
  }
  ...
  public void testRecycleBin()
    ...
    try (InputStream stream = this.getClass().getResourceAsStream("/test-files/" + fileName)) {
      ...
      assertTrue(
          hts.contains("C:\\Users\\Felipe Costa\\OneDrive\\Área de Trabalho\\test_lenaPng.png"));
    }
  }

  @Test
  public void testRecycleBinInfo2()
      throws IOException, TikaException, SAXException, TransformerException {
    ...
    try (InputStream stream = this.getClass().getResourceAsStream("/test-files/" + fileName)) {
      ...
      assertTrue(
          hts.contains(
              "C:\\Documents and Settings\\Administrator\\Desktop\\GetDataBackforFAT-v3.63_PConline"));
    }
  }

  @Test
  public void testEvtxLogParser()
      throws IOException, TikaException, SAXException, TransformerException {
