...
public class IconUtil {
  ...
  public static final Icon getIcon(String name, String resPath, int iconSize) {
    ...
    try {
      ...
      if (iconSize == 0) {
        ...
        double zoom =
            Math.min(iconSize / (double) img.getWidth(), iconSize / (double) img.getHeight());
  ...
  /**
   * Create a list of images with different resolutions, from a source image. This method is
   * intended to get images used as applications icons, passing the return list to
