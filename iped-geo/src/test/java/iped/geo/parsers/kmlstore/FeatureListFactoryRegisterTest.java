...
public class FeatureListFactoryRegisterTest {
  ...
  public void resolvesKmlFactory() {
    FeatureListFactory factory =
        FeatureListFactoryRegister.getFeatureList(GeofileParser.KML_MIME.toString());
  ...
  public void resolvesGpxFactory() {
    FeatureListFactory factory =
        FeatureListFactoryRegister.getFeatureList(GeofileParser.GPX_MIME.toString());
