...
public class FeatureListFactoryRegister {
  ...
  public static FeatureListFactory getFeatureList(String mimeType) {
    for (Iterator<FeatureListFactory> iterator = registeredFactories.iterator();
        iterator.hasNext(); ) {
  ...
  public static void addFeatureList(FeatureListFactory f) {
    registeredFactories.add(f);
  }

  public static void removeFeatureList(FeatureListFactory f) {
