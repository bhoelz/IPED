...
public class KMLParser {
  ...
  private static void parsePlacemarkTrack(
      Element ele, List<Object> features, SimpleFeatureBuilder featureBuilder) {
  ...
  public static Coordinate parsePoint(Element ele) {
    List<Element> eles = ele.getChildren();
  ...
  public static Coordinate parseCoordinate(Element coordsEle) {
  ...
  public static Coordinate parseCoordinate(String coordinates, String tokens) {
  ...
  public static Geometry parseGeometry(Element ele, GeometryFactory geometryFactory) {
    ...
    if (ele.getName().toLowerCase().equals("linestring")
        || ele.getName().toLowerCase().equals("linearring")) {
      List<Element> eles = ele.getChildren();
      Element coordsEle = null;
      for (Iterator<Element> iterator = eles.iterator(); iterator.hasNext(); ) {
        Element element = iterator.next();
    ...
    for (Iterator<Element> iterator = eles.iterator(); iterator.hasNext(); ) {
      ...
      try {
        ...
        if (ele.getName().toLowerCase().equals("extendeddata")) {
          ...
          if (data != null
              && data.getAttribute("name") != null
              && data.getAttribute("name").getValue().equals("iped.geo.track")) {
