 ...
 *
 * <p>Implementations must not reference any UI toolkit ({@code javafx}, {@code java.awt}, {@code
 * javax.swing}) so that this interface can be used from headless server contexts such as {@code
 * iped-webapi}.
 *
...
public interface IGeoDataService {
   ...
   *
   * <p>Items that carry no location metadata contribute zero features. Items that carry multiple
   * location values (e.g. GPX tracks, multi-waypoint KML) contribute one {@link GeoFeature} per
   * location.
   *
