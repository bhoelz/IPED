 ...
 *
 * <p>One item may contribute multiple {@code GeoFeature} instances (e.g. a GPX track
 * or a burst-photo set). All coordinates follow the GeoJSON convention: longitude
 * first, latitude second.
 *
 * <p>This type is part of the <em>headless geo data layer</em> ({@code iped.geo.data})
 * — it must remain free of any {@code java.awt}, {@code javax.swing}, or
 * {@code javafx} imports so it can be consumed from {@code iped-webapi} without
 * pulling in a UI toolkit.
 *
