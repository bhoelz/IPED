...
/**
 * Mutable statistics for a single running IPED job, updated from stdout lines.
 * Thread-safe: the I/O thread writes via {@link #addLine}, any thread reads via accessors.
 */
class RunStats {

    // Matches patterns like "1 234 items processed" or "processed 1234 of 5678 items"
    private static final Pattern ITEMS_PROCESSED = Pattern.compile(
