...
/**
 * Serves the IPED Processing Dashboard — a live view of all running and recently
 * completed processing jobs.
 *
 * <ul>
 *   <li>{@code GET /dashboard}        — Rocker SSR shell + React island</li>
 *   <li>{@code GET /dashboard/jobs}   — JSON snapshot of all jobs (initial page load)</li>
 *   <li>{@code GET /dashboard/stream} — SSE stream; pushes {@code jobs-update} every ~2 s</li>
 * </ul>
 */
@Controller
