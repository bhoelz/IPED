 ...
 *
 * <p>Runner JS/CSS files are versioned via the Maven project version so they get a long-lived
 * cache; vendor assets (htmx) are served immutable.
 */
@Configuration
