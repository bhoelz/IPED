 ...
 * <p>Health thresholds:
 * <ul>
 *   <li>{@code active}  — last heartbeat within 30 s</li>
 *   <li>{@code stale}   — 30–120 s ago</li>
 *   <li>{@code offline} — more than 120 s ago</li>
 * </ul>
 */
public record AgentRecord(
    ...
    AgentRecord withHealth(Instant now) {
        return new AgentRecord(agentId, hostname, startedAt, lastSeen,
                version, activeTasks, maxTasks, computeHealth(lastSeen, now));
    }
}
