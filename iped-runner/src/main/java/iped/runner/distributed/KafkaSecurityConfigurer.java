 ...
 * </table>
 *
 * <p>Call {@link #apply(Properties, KafkaSecurityConfig)} before constructing any
 * {@code KafkaProducer}, {@code KafkaConsumer}, or {@code AdminClient}.
 */
public final class KafkaSecurityConfigurer {
    ...
    /**
     * Applies security properties derived from {@code cfg} to {@code props}.
     * No-op when TLS is disabled and no SASL mechanism is set.
     *
    ...
    /**
     * Kafka security configuration value object.
     * Immutable; construct with the builder or record syntax.
     */
