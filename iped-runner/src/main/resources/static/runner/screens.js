// The five configuration screens for IPED Runner
...
// ============================ ENTRADAS ============================
function ScreenEntradas({ s, patch, t, getIssue, openBrowser }) {
  const tt = t.entradas;
...
// ============================ SAÍDA E LOGS ============================
function ScreenSaida({ s, patch, t, getIssue, openBrowser }) {
  const tt = t.saida;
...
function ScreenRelatorio({ s, patch, t }) {
...
// ============================ AVANÇADO ============================
function ScreenAvancado({ s, patch, t }) {
  const tt = t.avancado;
  return (
    <>
...
Object.assign(window, { ScreenEntradas, ScreenSaida, ScreenProcessamento, ScreenRelatorio, ScreenAvancado, PageHeader });
