...
/**
 * Fixture tests for EML carver configuration: EMLCarver receives its CarverType externally (from
 * CarverConfig.toml / XMLCarverConfiguration), so these tests verify that the expected
 * header/footer signatures decode correctly via the CarverType API rather than via a carver
 * constructor.
 */
