...
/**
 * Unit tests for {@link ContentV2} helper methods.
 * The {@code convertToPng} method is tested indirectly via its static-helper path;
 * the range parser is tested directly.
 */
