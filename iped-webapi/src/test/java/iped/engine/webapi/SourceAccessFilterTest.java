...
public class SourceAccessFilterTest {
  ...
  void extractsFromV2SourceTagsPath() {
    assertEquals(
        "case-1", SourceAccessFilter.extractSourceId("/v2/sources/case-1/items/5/tags/relevant"));
  }
  ...
  void percentDecodesSourceId() {
    assertEquals(
        "case with spaces",
        SourceAccessFilter.extractSourceId("/v2/sources/case%20with%20spaces/items/1"));
  }
