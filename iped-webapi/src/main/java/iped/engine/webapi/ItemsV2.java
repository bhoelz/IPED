 ...
 *
 * <p>Unlike {@code GET /sources/{sourceID}/docs/{id}} (which returns raw Lucene fields),
 * this endpoint returns a structured JSON object with typed fields from the
 * {@code IItem} interface, plus the full metadata map.
 *
 * <h2>Example</h2>
 * <pre>
...
public class ItemsV2 {
    ...
    @ApiOperation(
            ...
            notes = "Returns all structured metadata for the item including dates, hashes, " +
