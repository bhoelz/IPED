...
public class Renditions {
  ...
  public Response text(@PathParam("sourceID") String sourceID, @PathParam("id") int id) {
  ...
  public Response html(@PathParam("sourceID") String sourceID, @PathParam("id") int id) {
    return streamRendition(sourceID, id, "html", -1, 0, MediaType.TEXT_HTML + "; charset=UTF-8");
  }

  @ApiOperation(
      value = "Get image rendition of a document (PNG). Use ?page= for multi-page formats.")
  @GET
  @Path("image")
  @Produces("image/png")
  public Response image(
      ...
      @PathParam("id") int id,
      @ApiParam("0-based page index (default 0)") @QueryParam("page") @DefaultValue("0") int page,
  ...
  public Response pdf(@PathParam("sourceID") String sourceID, @PathParam("id") int id) {
    return streamRendition(sourceID, id, "pdf", -1, 0, "application/pdf");
  }

  private Response streamRendition(
      String sourceID, int id, String kind, int page, int width, String mediaType) {
        ...
        new StreamingOutput() {
          ...
          public void write(OutputStream output) throws IOException, WebApplicationException {
            try {
              Sources.services()
                  .renditions()
                  .writeRendition(sourceID, id, kind, page, width, output);
