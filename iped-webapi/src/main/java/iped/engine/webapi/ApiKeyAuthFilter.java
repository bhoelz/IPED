...
/**
 * Jersey {@link ContainerRequestFilter} that enforces API-key authentication
 * on all routes when a key is configured.
 *
 * <p>Configure via system property or environment variable (checked in order):
 * <ol>
 *   <li>{@code iped.webapi.api-key} system property</li>
 *   <li>{@code IPED_WEBAPI_API_KEY} environment variable</li>
 * </ol>
 *
 * <p>When no key is configured the filter is a no-op, preserving the current
 * open-access behaviour for development.
 *
