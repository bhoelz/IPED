...
public class ViewerSessions {
  ...
  public Response open(
    ...
    String mimeType =
        item.getMediaType() != null ? item.getMediaType().toString() : "application/octet-stream";

    String baseUrl = resolveBaseUrl(uriInfo);

    List<String> highlightTerms =
        request != null && request.getHighlightTerms() != null
            ? request.getHighlightTerms()
            : List.of();
  ...
  public Response search(
    ...
    List<Map<String, Object>> ranges =
        (List<Map<String, Object>>) result.getOrDefault("hitRanges", List.of());
