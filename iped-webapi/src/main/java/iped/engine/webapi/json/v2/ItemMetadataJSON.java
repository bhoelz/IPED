 ...
 * Combines the structured fields from {@link iped.data.IItemReader} with the raw Lucene metadata
 * map for forensic attribute access.
 */
public class ItemMetadataJSON {
  ...
  public void setParentIds(List<Integer> v) {
    this.parentIds = v;
  }
  ...
  public void setHasPreview(boolean v) {
    this.hasPreview = v;
  }
